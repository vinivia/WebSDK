...
runner.runCommands([
    ...
    ['gsutil', '-h', 'Cache-Control:public, max-age=60, stale-while-revalidate=604800, stale-if-error=259200, s-maxage=60, proxy-revalidate', '-m', 'cp', '-R', 'node_modules/phenix-*', 'node_modules/jquery', 'node_modules/lodash', 'node_modules/bootstrap', 'node_modules/bootstrap-notify', 'node_modules/fingerprintjs2', 'node_modules/shaka-player', 'node_modules/requirejs', 'node_modules/animate.css', 'gs://phenix-assets-us/examples']
]);