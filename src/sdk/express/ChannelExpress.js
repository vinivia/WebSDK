...
const RoomExpress = require('./RoomExpress');
const ChannelService = require('../room/ChannelService');
const Channel = require('../room/Channel');
...
const streamEnums = require('../room/stream.json');
