...
const http = require('phenix-web-http');
const applicationActivityDetector = require('phenix-web-application-activity-detector');
const environment = require('./environment');
const AudioContext = require('./audio/AudioContext');
const PCastProtocol = require('./PCastProtocol');
const PCastEndPoint = require('./PCastEndPoint');
const ScreenShareExtensionManager = require('./userMedia/ScreenShareExtensionManager');
const UserMediaProvider = require('./userMedia/UserMediaProvider');
const PeerConnectionMonitor = require('./streaming/PeerConnectionMonitor');
const DimensionsChangedMonitor = require('./DimensionsChangedMonitor');
const metricsTransmitterFactory = require('./telemetry/metricsTransmitterFactory');
const StreamTelemetry = require('./telemetry/StreamTelemetry');
const SessionTelemetry = require('./telemetry/SessionTelemetry');
const PeerConnection = require('./streaming/PeerConnection');
const StreamWrapper = require('./streaming/StreamWrapper');
const PhenixLiveStream = require('./streaming/PhenixLiveStream');
const PhenixRealTimeStream = require('./streaming/PhenixRealTimeStream');
const FeatureDetector = require('./streaming/FeatureDetector');
const streamEnums = require('./streaming/stream.json');
const BitRateMonitor = require('./streaming/BitRateMonitor');
const phenixRTC = require('phenix-rtc');
