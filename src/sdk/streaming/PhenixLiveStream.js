...
const ShakaRenderer = require('./ShakaRenderer');
const PhenixPlayerRenderer = require('./PhenixPlayerRenderer');
const FlashRenderer = require('./FlashRenderer');
...
module.exports = PhenixLiveStream;