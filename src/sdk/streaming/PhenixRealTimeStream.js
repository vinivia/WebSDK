...
const PeerConnectionMonitor = require('./PeerConnectionMonitor');
const BitRateMonitor = require('./BitRateMonitor');
const PhenixRealTimeRenderer = require('./PhenixRealTimeRenderer');
const FeatureDetector = require('./FeatureDetector');
...
module.exports = PhenixRealTimeStream;