...
define([
    ...
    describe('When Using a Custom Logger with PCast', function() {
        ...
        it('Expect an error to not be thrown when publishing', function() {
            expect(function() {
                pcast.publish('DIGEST:', UserMediaStubber.getMockMediaStream(), function() {});
            }).to.not.throw();
        });
    });
});