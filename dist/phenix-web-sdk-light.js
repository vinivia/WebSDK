 ...
 * limitations under the License.
 */
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(76)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(getGlobal) {
    'use strict';
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
    ...
    var sdkVersion = '2018-10-03T20:38:55Z';
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
    ...
    __webpack_require__(5)
], __WEBPACK_AMD_DEFINE_RESULT__ = (function(_, assert, event, rtc, PeerConnection, PeerConnectionMonitor, BitRateMonitor, PhenixRealTimeRenderer, streamEnums) {
    'use strict';
