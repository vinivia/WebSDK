 ...
 * limitations under the License.
 */
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(105)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(getGlobal) {
    'use strict';
 ...
 */
!function(e,t){if(true)module.exports=t(__webpack_require__(1),__webpack_require__(0),__webpack_require__(8),__webpack_require__(5),__webpack_require__(2),__webpack_require__(3),__webpack_require__(6),__webpack_require__(42),__webpack_require__(35));else { var n, i; }}(this,function(e,t,i,n,r,a,s,o,l){return function(e){function t(n){if(i[n])return i[n].exports;var r=i[n]={i:n,l:!1,exports:{}};return e[n].call(r.exports,r,r.exports,t),r.l=!0,r.exports}var i={};return t.m=e,t.c=i,t.d=function(e,i,n){t.o(e,i)||Object.defineProperty(e,i,{configurable:!1,enumerable:!0,get:n})},t.n=function(e){var i=e&&e.__esModule?function(){return e.default}:function(){return e};return t.d(i,"a",i),i},t.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},t.p="",t(t.s=21)}([function(t,i){t.exports=e},function(e,i){e.exports=t},function(e,t){e.exports=i},function(e,t){e.exports=n},function(e,t){e.exports=r},function(e,t,i){var n,r;n=[i(1),i(0),i(2),i(3),i(4),i(10),i(7),i(22),i(23),i(13),i(14),i(26),i(6)],void 0!==(r=function(e,t,i,n,r,a,s,o,l,u,c,d,h){"use strict";function g(e,a){a&&t.isStringNotEmpty(a,"playlistUrl"),this.parsedPlaylist=null,this._logger=e||new i.Logger,this.playlistUrl=a,this.baseUrl=a?a.substring(0,a.lastIndexOf("/")+1):"",this._name=a?a.substring(a.lastIndexOf("/"),a.length):"",this._trackAddedEvent=new n.Event,this._playlistTracksByMimeType={},this._mimeTypes=[],this._deliveryType=p(this.playlistUrl),this._type=null,this._localToServerTimeOffset=0,this._disposables=new r.DisposableList,this._disposables.add(this._trackAddedEvent)}function f(i,n){t.isInstanceOf(i,s,"track"),n=n||e.noop,t.isFunction(n,"eventCallback");var a=i.getMimeType();this._playlistTracksByMimeType[a]||(this._playlistTracksByMimeType[a]=[]),e.includes(this._playlistTracksByMimeType[a],i)||this._playlistTracksByMimeType[a].push(i),e.includes(this._mimeTypes,a)||this._mimeTypes.push(a),this._disposables.add(new r.Disposable(function(){i.dispose()})),this._trackAddedEvent.fireAsync([i],this,n)}function p(e){return/[.]mpd\??[^\s]*/i.test(e)?"Dash":/[.]m3u8\??[^\s]*/i.test(e)?"Hls":null}function m(t,i,n){if(this._logger.error("Failed to load playlist [%s]. Status code: [%s] (status text: [%s])",this.playlistUrl,t.code,t.message),i&&i.attempts===_){var r="Failed to get playlist with max retries of ["+_+" after ["+e.get(i,["stats","totalResponseTimeForAllAttempts"],0)+"] ms";return n(y(h.name.playlistNotFound.name,h.severity.CRITICAL,r))}if(0===t.code){var a="Failed to get playlist with timeout after ["+e.get(i,["stats","totalResponseTimeForAllAttempts"],0)+"]";return n(y(h.name.timeout.name,h.severity.RECOVERABLE,a))}return n(y(h.name.error.name,h.severity.CRITICAL,t))}function y(e,t,i){return{category:h.category.PLAYLIST,name:e,severity:t,error:"Error"===i.constructor.name?i:new Error(i)}}var _=5,v=0;return g.prototype.toString=function(){return"Playlist [playlistUrl="+this.playlistUrl+", baseUrl="+this.baseUrl+", mimeTypes="+this._mimeTypes+", trackAddedEvent(size)="+this._trackAddedEvent.size()+", playlistTracks="+this.getAllPlaylistTracks()+"]"},g.prototype.dispose=function(){this._playlistTracksByMimeType={},this._disposables.dispose()},g.prototype.getPlaylistTracksByMimeType=function(e){return this._playlistTracksByMimeType[e]},g.prototype.fetch=function(t){(function(t){var i=this;a.getWithRetry(i.playlistUrl,{retryOptions:{backoff:1,delay:1e3,maxAttempts:_,additionalRetryErrorCodes:[v]}},function(n,r){if(n)return m.call(i,n,r,t);(function(t,i,n){var r=null,s=[],h=this;switch(this._deliveryType){case"Dash":r=new u(h._logger,t);var g=new d(h._logger,r.timeSources,i);h._disposables.add(g),h.parsedPlaylist=r,h._availabilityStartTime=h.parsedPlaylist.availabilityStartTime?h.parsedPlaylist.availabilityStartTime.getTime():null,h._publishTime=h.parsedPlaylist.publishTime?h.parsedPlaylist.publishTime.getTime():null,h._suggestedPresentationDelayTotalMillis=e.get(h.parsedPlaylist,["suggestedPresentationDelay","totalMillis"],null),h._totalMediaTimeInMillis=e.get(h.parsedPlaylist,["mediaPresentationDuration","totalMillis"],1/0),h._minBufferTimeTotalMillis=e.get(h.parsedPlaylist,["minBufferTime","totalMillis"],null),h._type=h.parsedPlaylist.type,s=function(t){var i=this;return e.map(t.representations,function(e){return{chunkDuration:e.duration,dataChunkUrlTemplate:e.media,codec:e.mseCodec,bandwidth:e.bandwidth,height:e.height,trackId:e.id,initUrl:e.initialization,mimeType:e.mimeType,totalNumberOfChunks:Math.ceil(i._totalMediaTimeInMillis/e.duration)}})}.call(h,h.parsedPlaylist),e.forEach(s,function(e){f.call(h,new o(h._logger,e))}),g.calculateOffset(function(e,t){h._localToServerTimeOffset=t,n()}),g.setInterval(function e(t,i){if(t)return h._warn("Unable to get server local time offset",t),g.setInterval(e);h._localToServerTimeOffset=i});break;case"Hls":r=new c(h._logger,h._name,t),h.parsedPlaylist=r,h._availabilityStartTime=null,h._minBufferTimeTotalMillis=0,h._suggestedPresentationDelayTotalMillis=0,h._totalMediaTimeInMillis=1/0;var y=0;e.forEach(r.streamVariants,function(e){var t=h.baseUrl+e.name,i=new l(h._logger,{mediaSegmentPlaylistUrl:t,codecs:e.codecs.join(","),bandwidth:e.bandwidth,trackId:e.name,mimeType:"application/octet-stream",height:null});a.getWithRetry(t,{retryOptions:{maxAttempts:_,backoff:1}},function(e,t){if(e)return m.call(h,e,t,n);i.updateMediaSegments(t.data),f.call(h,i),++y===r.streamVariants.length&&(h._type=i.isComplete()?"static":"dynamic","static"===h._type&&(h._totalMediaTimeInMillis=1e3*i.getPlayableDuration()),n())})});break;default:throw h._logger.error("[%s] Unsupported Delivery Type [%s]",h.playlistUrl,p(h.playlistUrl)),new Error("Unsupported Delivery Type "+p(h.playlistUrl))}}).call(i,r.data,r.stats.successResponseTime,function(){t(n,{raw:r,parsed:i.parsedPlaylist})})})}).call(this,t)},g.prototype.getType=function(){return this._type},g.prototype.getDeliveryType=function(){return this._deliveryType},g.prototype.getPlaylistTracksByBandwidthPerMimeType=function(i,n){t.isObject(n,"restrictions");var r=this;return e.map(this._mimeTypes,function(t){var a=function(t,i){return 0===e.keys(i).length?t:e.filter(t,function(t){return function(t,i){var n=t.getHeight()||0,r=t.getBandwidth()||0;return e.reduce(i,function(e,t,i){switch(i){case"maxHeight":return n<=t;case"minHeight":return n>=t;case"maxBandwidth":return r<=t;case"minBandwidth":return r>=t;default:throw new Error("Unknown restriction "+i)}},!1)}(t,i)})}(r.getPlaylistTracksByMimeType(t),n),s=e.reduce(a,function(e,t){return t.getBandwidth()>i?e:e&&e.getBandwidth()>t.getBandwidth()?e:t},null)||r.getPlaylistTrackByMimeTypeAndNextHighestBandwidth(0,t);if(s)return s;var o=e.get(e.filter(a,function(e){return!e.getBandwidth()}),"0");if(o)return r._logger.debug("Unable to get track with bandwidth [%s]. Falling back to track [%s].",o.getTrackId()),o;r._logger.warn("Unable to get track with bandwidth [%s]. No other tracks to fallback on.")})},g.prototype.getPlaylistTrackByBandwidthAndMimeType=function(t,i){return e.find(this.getPlaylistTracksByBandwidthPerMimeType(t,{}),function(e){return e.getMimeType()===i})},g.prototype.getPlaylistTrackByMimeTypeAndNextHighestBandwidth=function(t,i){return e.reduce(this.getPlaylistTracksByMimeType(i),function(e,i){return i.getBandwidth()<=t?e:e?e.getBandwidth()>i.getBandwidth()?i:e:i},null)},g.prototype.getAllPlaylistTracks=function(){return[].concat.apply([],e.values(this._playlistTracksByMimeType))},g.prototype.getMimeTypes=function(){return this._mimeTypes},g.prototype.getPlaybackDurationSinceAvailable=function(){return this.currentServerTime()-this._availabilityStartTime},g.prototype.getPlaybackDurationSincePublish=function(){return this.currentServerTime()-this._publishTime},g.prototype.getSuggestedPresentationDelayTotalMillis=function(){return this._suggestedPresentationDelayTotalMillis},g.prototype.getTotalMediaTimeInMillis=function(){return this._totalMediaTimeInMillis},g.prototype.getMinBufferTimeTotalMillis=function(){return this._minBufferTimeTotalMillis},g.prototype.getLocalToServerTimeOffset=function(){return this._localToServerTimeOffset},g.prototype.currentServerTime=function(){return e.now()-this._localToServerTimeOffset},g.prototype.getMaxChunkDuration=function(){return e.reduce(this.getAllPlaylistTracks(),function(e,t){return Math.max(t.getChunkDuration(),e)},0)},g.prototype.addEventListener=function(e,i){switch(t.isString(e,"eventName"),t.isFunction(i,"listener"),e){case"trackadded":return this._trackAddedEvent.listen(i);default:throw new Error('Event "'+e+'" is unknown.')}},g}.apply(t,n))&&(e.exports=r)},function(e,t,i){var n;void 0!==(n=function(){"use strict";return{name:{chunkNotFound:{id:0,name:"chunk-not-found"},timeout:{id:1,name:"timeout"},error:{id:2,name:"error"},playlistNotFound:{id:3,name:"playlist-not-found"},progressTimeOut:{id:4,name:"progress-timeout"},hlsNativeError:{id:5,name:"hls-native-error"}},category:{PLAYLIST:4,STREAMING:5,DRM:6},severity:{RECOVERABLE:1,CRITICAL:2}}}.apply(t,[]))&&(e.exports=n)},function(e,t,i){var n,r;n=[i(0),i(3),i(2)],void 0!==(r=function(e,t,i){"use strict";function n(e,t,i){}return n.prototype.toString=function(){throw new Error("Must be implemented")},n.prototype.dispose=function(){throw new Error("Must be implemented")},n.prototype.getMseCodec=function(){throw new Error("Must be implemented")},n.prototype.getTrackId=function(){throw new Error("Must be implemented")},n.prototype.getChunkDuration=function(){throw new Error("Must be implemented")},n.prototype.getBandwidth=function(){throw new Error("Must be implemented")},n.prototype.getHeight=function(){throw new Error("Must be implemented")},n.prototype.getMimeType=function(){throw new Error("Must be implemented")},n.prototype.getTotalNumberOfChunks=function(){throw new Error("Must be implemented")},n.prototype.getCurrentChunkId=function(){throw new Error("Must be implemented")},n.prototype.setCurrentChunkId=function(e){throw new Error("Must be implemented")},n.prototype.incrementCurrentChunkId=function(){throw new Error("Must be implemented")},n.prototype.addDataChunk=function(e,t,i){throw new Error("Must be implemented")},n.prototype.getChunks=function(){throw new Error("Must be implemented")},n.prototype.addEventListener=function(e,t){throw new Error("Must be implemented")},n}.apply(t,n))&&(e.exports=r)},function(e,t){e.exports=a},function(e,t,i){var n,r;n=[i(1),i(2)],void 0!==(r=function(e,t){"use strict";function i(e,i){this._options=i||{},this._logger=e||new t.Logger,this._rateDataPoints={},this._ewmaPeriods=i.ewmaPeriods||null,this._ewmaMultiplier=this._ewmaPeriods?2/(this._ewmaPeriods+1):null}function n(e,t,i,n,r){var a=(i*(e.length-1)+r(t))/e.length;if(n>0)for(;t.added-e[0].added>n;){var s=e.shift();a=(a*(e.length+1)-r(s))/e.length}return a}return i.prototype.toString=function(){var t=this;return"StatsProvider [rateDataPoints(keys)="+e.keys(this._rateDataPoints)+", rateDataPoints="+e.toString(e.map(this._rateDataPoints,function(e,i){return t.getRateAverages(i)}))+", options="+this._options+"]"},i.prototype.dispose=function(){delete this._rateDataPoints},i.prototype.addRateDataPoint=function(t,i,r,a){if(!e.isNullOrUndefined(this._rateDataPoints)){this._rateDataPoints[t]||(this._rateDataPoints[t]={tenSecDataPoints:[],thirtySecDataPoints:[],oneMinDataPoints:[],twoMinDataPoints:[],ewmaDataPoints:[],tenSecAverageRate:0,thirtySecAverageRate:0,oneMinAverageRate:0,twoMinAverageRate:0,ewmaRate:0,smaRate:0,tenSecAverageDuration:0,thirtySecAverageDuration:0,oneMinAverageDuration:0,twoMinAverageDuration:0,ewmaDuration:0,smaDuration:0});var s={duration:i,amount:r,durationToSecondsFactor:a,rate:r/(i*a),added:e.now()};(function(e,t){var i=function(e){return e.rate},r=function(e){return e.duration};e.tenSecDataPoints.push(t),e.thirtySecDataPoints.push(t),e.oneMinDataPoints.push(t),e.twoMinDataPoints.push(t),e.tenSecAverageRate=n.call(this,e.tenSecDataPoints,t,e.tenSecAverageRate,1e4,i),e.thirtySecAverageRate=n.call(this,e.thirtySecDataPoints,t,e.thirtySecAverageRate,3e4,i),e.oneMinAverageRate=n.call(this,e.oneMinDataPoints,t,e.oneMinAverageRate,6e4,i),e.twoMinAverageRate=n.call(this,e.twoMinDataPoints,t,e.twoMinAverageRate,12e4,i),e.tenSecAverageDuration=n.call(this,e.tenSecDataPoints,t,e.tenSecAverageDuration,1e4,r),e.thirtySecAverageDuration=n.call(this,e.thirtySecDataPoints,t,e.thirtySecAverageDuration,3e4,r),e.oneMinAverageDuration=n.call(this,e.oneMinDataPoints,t,e.oneMinAverageDuration,6e4,r),e.twoMinAverageDuration=n.call(this,e.twoMinDataPoints,t,e.twoMinAverageDuration,12e4,r),this._ewmaMultiplier&&(e.ewmaDataPoints.push(t),e.smaRate=n.call(this,e.ewmaDataPoints,t,e.smaRate,-1,i),e.smaDuration=n.call(this,e.ewmaDataPoints,t,e.smaDuration,-1,r),e.ewmaDataPoints.length>=this._ewmaPeriods&&(e.ewmaDataPoints.shift(),e.ewmaDataPoints.length===this._ewmaPeriods?(e.ewmaRate=e.smaRate,e.ewmaDuration=e.smaDuration):(e.ewmaRate=this._ewmaMultiplier*(e.smaRate-e.ewmaRate)+e.ewmaRate,e.ewmaDuration=this._ewmaMultiplier*(e.smaDuration-e.ewmaDuration)+e.ewmaDuration)))}).call(this,this._rateDataPoints[t],s)}},i.prototype.getRateAverages=function(t){if(!e.get(this._rateDataPoints,[t]))return{tenSecAverageRate:0,thirtySecAverageRate:0,oneMinAverageRate:0,twoMinAverageRate:0,ewmaRate:0,tenSecAverageDuration:0,thirtySecAverageDuration:0,oneMinAverageDuration:0,twoMinAverageDuration:0,ewmaDuration:0};var i=this._rateDataPoints[t];return{tenSecAverageRate:i.tenSecAverageRate,thirtySecAverageRate:i.thirtySecAverageRate,oneMinAverageRate:i.oneMinAverageRate,twoMinAverageRate:i.twoMinAverageRate,ewmaRate:i.ewmaRate,tenSecAverageDuration:i.tenSecAverageDuration,thirtySecAverageDuration:i.thirtySecAverageDuration,oneMinAverageDuration:i.oneMinAverageDuration,twoMinAverageDuration:i.twoMinAverageDuration,ewmaDuration:i.ewmaDuration}},i}.apply(t,n))&&(e.exports=r)},function(e,t){e.exports=s},function(e,t){e.exports=o},function(e,t,i){var n;void 0!==(n=function(){"use strict";function e(e,t,i,n){}return e.prototype.toString=function(){throw new Error("Must be implemented")},e.prototype.dispose=function(){throw new Error("Must be implemented")},e.prototype.initialize=function(e,t,i,n){throw new Error("Must be implemented")},e.prototype.setActiveTracks=function(e){throw new Error("Must be implemented")},e.prototype.initializePlaylistTracks=function(e,t,i,n){throw new Error("Must be implemented")},e.prototype.startRequestingDataForActiveTracks=function(){throw new Error("Must be implemented")},e.prototype.isFetchingData=function(){throw new Error("Must be implemented")},e.prototype.seekToChunk=function(e){throw new Error("Must be implemented")},e.prototype.stopRequestingAllData=function(){throw new Error("Must be implemented")},e}.apply(t,[]))&&(e.exports=n)},function(e,t,i){var n,r;n=[i(1),i(0),i(25)],void 0!==(r=function(e,t,i){"use strict";function n(n,a){t.isStringNotEmpty(a,"mpdXml"),t.isObject(n,"logger"),this._mpdXml=a,this._logger=n,this.minBufferTime=0,this.type=null,this.publishTime=null,this.availabilityStartTime=null,this.timeShiftBufferDepth=0,this.suggestedPresentationDelay=0,this.minimumUpdatePeriod=0,this.maxSegmentDuration=0,this.profiles=null,this.moreInfoUrl=null,this.programInfoTitle=null,this.representations=[],function(){t.isStringNotEmpty(this._mpdXml,"mpdXml");var n,a=i.parseXml(this._mpdXml),u=a.getElementsByTagName("parsererror");if(u&&u.length>0)throw n="Failed to parse MPD Playlist XML: "+u.item(0).innerText+" (source xml: "+this._mpdXml+")",this._logger.error(n),new Error(n);if("MPD"!==a.documentElement.nodeName)throw n='Invalid MPD Playlist XML. Does not start with "MPD": '+this._mpdXml,this._logger.error(n),new Error(n);this.minBufferTime=r(o(a.documentElement,"minBufferTime")),this.type=o(a.documentElement,"type"),this.publishTime=s(o(a.documentElement,"publishTime")),this.availabilityStartTime=s(o(a.documentElement,"availabilityStartTime")),this.timeShiftBufferDepth=r(o(a.documentElement,"timeShiftBufferDepth")),this.suggestedPresentationDelay=r(o(a.documentElement,"suggestedPresentationDelay")),this.minimumUpdatePeriod=r(o(a.documentElement,"minimumUpdatePeriod")),this.maxSegmentDuration=r(o(a.documentElement,"maxSegmentDuration")),this.mediaPresentationDuration=r(o(a.documentElement,"mediaPresentationDuration")),this.profiles=o(a.documentElement,"profiles");var c=a.getElementsByTagName("ProgramInformation"),d=a.getElementsByTagName("UTCTiming");if(c&&c.length>=1){var h=c.item(0);this.programInfoTitle=l(h,"Title").childNodes[0].nodeValue,this.moreInfoUrl=o(h,"moreInformationURL")}var g=a.getElementsByTagName("ContentProtection");if(this.contentProtectionTags=[],g.length>0)for(var f=0;f<g.length;f++){var p=g.item(f),m=e.reduce(p.attributes,function(e,t){return e[t.name]=t.value,e},{});this.contentProtectionTags.push(m)}for(var y=a.getElementsByTagName("Representation"),_=0;_<y.length;_++){var v=function(e){var t={};if(t.id=o(e,"id"),t.mimeType=o(e,"mimeType"),t.codecs=o(e,"codecs"),t.mseCodec=i.getMSECodec(t.mimeType,t.codecs),t.isAudio=t.mimeType.indexOf("audio")>=0,t.isVideo=t.mimeType.indexOf("video")>=0,!i.isCodecSupported(t.mseCodec))return this._logger.debug("MPD representation has unsupported codec. Skipping stream id [%s] (mimeType=[%s], codecs=[%s])",t.id,t.mimeType,t.codecs),null;var n=o(e,"bandwidth");t.bandwidth=n?parseInt(n,10):null;var r=o(e,"height");t.height=r?parseInt(r,10):null;var a=l(e,"SegmentTemplate");a&&(t.timescale=parseInt(o(a,"timescale")),t.media=o(a,"media"),t.startNumber=parseInt(o(a,"startNumber")),t.duration=parseInt(o(a,"duration")),t.initialization=o(a,"initialization"));return t}.call(this,y.item(_));v&&this.representations.push(v)}this.timeSources=[];for(var b=0;b<d.length;b++){var k=d.item(b),w=o(k,"schemeIdUri"),T=o(k,"value"),E=s(T);this.timeSources.push({name:w,value:isNaN(E.getTime())?T:E.getTime()})}}.call(this)}function r(e){if(!e)return null;var t=/^(-)?P(?:(-?[0-9,.]*)Y)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)W)?(?:(-?[0-9,.]*)D)?(?:T(?:(-?[0-9,.]*)H)?(?:(-?[0-9,.]*)M)?(?:(-?[0-9,.]*)S)?)?$/.exec(e);if(t){var i="-"===t[1]?-1:1,n={year:a(t[2],i),month:a(t[3],i),week:a(t[4],i),day:a(t[5],i),hour:a(t[6],i),minute:a(t[7],i),second:a(t[8],i)};return n.totalMillis=1e3*(n.second+60*(n.minute+60*(n.hour+24*n.day))),n}return null}function a(e,t){var i=e&&parseFloat(e.replace(",","."));return(isNaN(i)?0:i)*t}function s(e){if(!e)return null;var t=new Date;return t.setTime(Date.parse(e)),t}function o(e,t){var i=e.attributes.getNamedItem(t);return i?i.value:null}function l(e,t){for(var i=0;i<e.childNodes.length;i++){var n=e.childNodes.item(i);if(n.nodeName===t)return n}return null}return n.prototype.toString=function(){return"Mpd [minBufferTime="+this.minBufferTime+", type="+this.type+", publishTime="+this.publishTime+", availabilityStartTime="+this.availabilityStartTime+", timeShiftBufferDepth="+this.timeShiftBufferDepth+", suggestedPresentationDelay="+this.suggestedPresentationDelay+", minimumUpdatePeriod="+this.minimumUpdatePeriod+", maxSegmentDuration="+this.maxSegmentDuration+", profiles="+this.profiles+", moreInfoUrl="+this.moreInfoUrl+", programInfoTitle="+this.programInfoTitle+", representations="+JSON.stringify(this.representations)+"]"},n}.apply(t,n))&&(e.exports=r)},function(e,t,i){var n,r;n=[i(1),i(0)],void 0!==(r=function(e,t){"use strict";function i(i,r,a){t.isStringNotEmpty(a,"M3u8VariantPlaylistString"),t.isStringNotEmpty(r,"name"),t.isObject(i,"logger"),this._rawM3u8VariantPlaylist=a,this._name=r,this._logger=i,function(t){var i=t.match(/[^\r\n]+/g),r=this;return e.forEach(i,function(t,a){var s=t.match(/(?!#)EXT.+?(?=[:\n\r])/),o=e.get(s,["0"],null),l=t.trim().substring(o?o.length+2:0,t.length);switch(o){case"EXT-X-STREAM-INF":r.streamVariants=r.streamVariants||[];var u=[l,i[a+1]];r.streamVariants.push(function(t){var i=(function(t){var i=e.get(t.match(/(?:CODECS=).*?",/),["0"],""),n=e.get(i.split("="),["1"],"");return n.substring(1,n.length-2)}(t[0])||"").split(","),r=(n(t[0],"FRAME-RATE")||"").trim();return{programId:n(t[0],"PROGRAM-ID"),codecs:i,bandwidth:parseInt(n(t[0],"BANDWIDTH")),averageBandwidth:parseInt(n(t[0],"AVERAGE-BANDWIDTH")),frameRate:parseInt(parseInt(r)||0),name:e.get(t,["1"],"").trim()}}(u));break;case"EXT-X-ALLOW-CACHE":r.allowCache="YES"===l;break;case"#EXT-X-COMBINED":r.combined="YES"===l;break;case"EXTM3U":case null:break;default:return r._logger.debug("[%s] [Variant] Playlist unsupported key type [%s]",r._name,o)}}),r}.call(this,this._rawM3u8VariantPlaylist)}function n(t,i){var n=new RegExp("(?:"+i+"=).*?(?=[,\n\r])"),r=new RegExp("(?:"+i+"=).*?$"),a=e.get(t.match(n)||t.match(r),["0"],"");return e.get(a.split("="),["1"])}return i.prototype.toString=function(){return"M3u8VariantPlaylist[name="+this._name+",numberOfStreamVariants="+this.streamVariants.length+"]"},i}.apply(t,n))&&(e.exports=r)},function(e,t,i){var n,r;n=[i(1),i(0),i(2),i(3),i(16),i(12),i(5),i(7),i(9),i(13),i(6)],void 0!==(r=function(e,t,i,n,r,a,s,o,l,u,c){"use strict";function d(a,o,c,d){t.isInstanceOf(o,s,"playlist"),t.isInstanceOf(o.parsedPlaylist,u,"playlist.parsedPlaylist"),t.isInstanceOf(c,l,"statsProvider"),t.isStringNotEmpty(o.playlistUrl,"playlist.playlistUrl"),t.isStringNotEmpty(o.baseUrl,"playlist.baseUrl"),t.isNumber(d.targetLatency,"options.targetLatency"),d&&d.defaultPresentationDelay&&t.isNumber(d.defaultPresentationDelay,"options.defaultPresentationDelay"),this._playlist=o,this._baseUrl=this._playlist.baseUrl,this._statsProvider=c,this._logger=a||new i.Logger,this._httpRequestManager=new r(this._logger),this._feederErrorEvent=new n.Event,this._activeTracks=[],this._currentPlaybackTimeInSeconds=0,this._keepFetchingData=!1,this._defaultPresentationDelay=e.get(d,"defaultPresentationDelay",w),this._targetLatencyInMilliseconds=1e3*d.targetLatency,this._timeOfChunkAvailabilityDelta={average:0,values:[],maxSize:10}}function h(e){var t=Math.max(this._targetLatencyInMilliseconds?this._targetLatencyInMilliseconds:0,0),i=this._playlist.getPlaybackDurationSinceAvailable(),n=Math.max(Math.ceil((i-t)/e),0);return"static"===this._playlist.getType()&&(n=0),this._logger.trace("Getting chunk index to start: [%s], playbackTimePassed=[%s], duration=[%s]",n,i,e),n}function g(){var t=this;e.forEach(t._activeTracks,function(e){e.setCurrentChunkId(f.call(t,e.getChunkDuration()))})}function f(e){var t=e/1e3;return Math.floor(this._currentPlaybackTimeInSeconds/t)}function p(t){var i=this,n=i._activeTracks.length;e.forEach(i._activeTracks,function(r,a){!function(r,a){if(e.find(i._activeTracks,function(e){return e.getMimeType()===r.getMimeType()})===r){var s=f.call(i,r.getChunkDuration()),o=s>=r.getTotalNumberOfChunks();if("static"===i._playlist.getType()&&o)return a===n-1&&(i._keepFetchingData=!1),i._logger.info("Finished getting chunks for [static] track [%s] [%s]",r.getTrackId(),r.getMimeType());e.isNullOrUndefined(t)&&"dynamic"===i._playlist.getType()&&(t=m.call(i,r)),y.call(i,r,1,t,function(e){if(e&&e.causes&&e.causes.length>0&&"not yet available"===e.causes[0].feederReason?i._logger.info("Failed to get next chunk (packet not yet available) for [%s]|[%s]. Trying to fetch again in [%s] ms.",r.getMseCodec(),r.getBandwidth(),k):(e&&i._logger.warn("Failed to get next chunk (# of errors=[%s], errors=[%s]). Moving on.",e.causes?e.causes.length:"n/a",e),n--),n<=0&&i._keepFetchingData){if("dynamic"===i._playlist.getType()){var t=m.call(i,r);return i._logger.debug("Done fetching chunk with index [%s] for each active track. Waiting for [%s] ms before moving on to next chunk.",s,t),p.call(i,t)}i._logger.debug("Done fetching chunk with index [%s] for each active track. Moving on to next chunk",s),p.call(i,null)}})}}(r,a)})}function m(e){var t=1e3*this._currentPlaybackTimeInSeconds+2*e.getChunkDuration()-this._playlist.getPlaybackDurationSinceAvailable(),i=Math.max(t,0);return Math.min(e.getChunkDuration(),i)+this._timeOfChunkAvailabilityDelta.average}function y(e,t,i,n){var r=this;(function(e,t,i){var n=this,r=function(e,t){return e.replace("$Number%05d$",("00000"+t).substr(-5))}(n._baseUrl+e.getDataChunkUrlTemplate(),e.getCurrentChunkId()),a=e.getCurrentChunkId();n._logger.trace("Fetching data chunk for [%s]: [%s], nextChunkId=[%s]",e.getMseCodec(),r,e.getCurrentChunkId());var s=e.getMseCodec();_.call(n,r,t,k,function(o,l){if(n._logger.trace("DONE Fetching data chunk for [%s] : [%s], nextChunkId=[%s]",s,r,e.getCurrentChunkId()+(o?": FAILED: "+o.code:": data="+l.data.byteLength)),!o){n._statsProvider.addRateDataPoint(s,l.stats.successResponseTime,l.data.byteLength,.001);var u=l.stats.totalResponseTimeForAllAttempts-l.stats.successResponseTime-Math.max(t,0);if(n._timeOfChunkAvailabilityDelta.values.push(u),n._timeOfChunkAvailabilityDelta.average=(n._timeOfChunkAvailabilityDelta.average*(n._timeOfChunkAvailabilityDelta.values.length-1)+u)/n._timeOfChunkAvailabilityDelta.values.length,n._timeOfChunkAvailabilityDelta.values.length>n._timeOfChunkAvailabilityDelta.maxSize){var c=n._timeOfChunkAvailabilityDelta.values.shift();n._timeOfChunkAvailabilityDelta.average=(n._timeOfChunkAvailabilityDelta.average*(n._timeOfChunkAvailabilityDelta.values.length+1)-c)/n._timeOfChunkAvailabilityDelta.values.length}}if(!o&&a===e.getCurrentChunkId())return e.incrementCurrentChunkId(),n._currentPlaybackTimeInSeconds=e.getChunkDuration()*e.getCurrentChunkId()/1e3,e.addDataChunk(l.data,a,function(){i(o)});o?(o.feederReason=404===o.code?"not yet available":"other",i(o)):i(null,l.data)})}).call(r,e,i,function(a){return a&&r._logger.trace('Failed to fetch data chunk of stream for config [%s]". Error: [%s]',e,a),!a&&t>1&&y.call(r,e,t-1,i,n),n(a)})}function _(t,i,n,r){var a=this,s={responseType:"arraybuffer",retryOptions:{delay:n,maxAttempts:b},timeout:T};if(e.isNumber(i)&&0!==i)s.delay=i;else if(!e.isNullOrUndefined(i)&&0!==i)throw new Error('"delay" must be a positive number greater than or equal to 0 or null or undefined');return this._httpRequestManager.getWithRetry(t,s,function(i,n){if(i){if(a._logger.debug("Failed to load next stream data chunk. Status code: [%s] (status text: [%s]) for [%s]",i.code,i.message,t),n&&n.attempts===b){var s="Failed to get chunk with max retries of ["+b+" after ["+e.get(n,["stats","totalResponseTimeForAllAttempts"],0)+"] ms";return a._logger.warn(s),a._feederErrorEvent.fire([v(c.name.chunkNotFound.name,c.severity.CRITICAL,s)])}if(0===i.code){var o="Failed to get chunk with timeout after ["+e.get(n,["stats","totalResponseTimeForAllAttempts"],0)+"] ms with chunk timeout of ["+T+"]";return a._logger.warn(o),a._feederErrorEvent.fire([v(c.name.timeout.name,c.severity.RECOVERABLE,o)])}return a._feederErrorEvent.fire([v(c.name.error.name,c.severity.CRITICAL,i)])}r(i,n)})}function v(e,t,i){return{category:c.category.STREAMING,name:e,severity:t,error:"Error"===i.constructor.name?i:new Error(i)}}var b=15,k=150,w=0,T=5e3;return d.prototype=Object.create(a.prototype),d.prototype.constructor=d,d.prototype.toString=function(){return"MpdPlaylistChunkFeeder [mpdPlaylistUrl="+this._playlist.playlistUrl+", baseUrl="+this._baseUrl+", defaultPresentationDelay="+this._defaultPresentationDelay+"]"},d.prototype.addEventListener=function(e,i){switch(t.isString(e,"eventName"),t.isFunction(i,"listener"),e){case"error":return this._feederErrorEvent.listen(i);default:throw new Error('Event "'+e+'" is unknown.')}},d.prototype.dispose=function(){this.stopRequestingAllData(e.noop),this._httpRequestManager.dispose(),this._playlist.dispose(),this._statsProvider.dispose(),this._feederErrorEvent.dispose(),this._activeTracks=null,this._currentPlaybackTimeInSeconds=0},d.prototype.initializeActiveTracks=function(i){var n=this;t.isFunction(i,"callback");var r=e.filter(this._activeTracks,function(e){return!e.getInitChunkData()});if(0===r.length)return i();(function(i,n){t.isArray(i,"tracks"),t.isFunction(n,"callback");var r=0,a=this;e.forEach(i,function(e){t.isInstanceOf(e,o,"track"),e.setCurrentChunkId(h.call(a,e.getChunkDuration())),function(e,t){var i=this;(function(e,t){var i=this;i._logger.trace("Fetching init chunk for [%s]: [%s], nextChunkId=[%s]",e.getMseCodec(),i._baseUrl+e.getInitUrl(),e.getCurrentChunkId()),_.call(i,i._baseUrl+e.getInitUrl(),null,500,function(n,r){i._logger.trace("DONE Fetching init chunk for [%s]: [%s], nextChunkId=[%s]",e.getMseCodec(),i._baseUrl+e.getInitUrl(),e.getCurrentChunkId()+(n?": FAILED: "+n.code:": data="+r.data.byteLength)),t(n,r.data)})}).call(i,e,function(n,r){if(n){var a=new Error("Failed to fetch init chunk of stream for config [%s]",e);return a.cause=n,i._logger.error("[%s] (Cause: [%s])",a.message,n),t(a)}e.setInitChunkData(r),i._logger.debug("Got init chunk for track [%s]",e.getTrackId()),t()})}.call(a,e,function(e){if(e)return n(e);++r===i.length&&n()})})}).call(n,r,i,function(e){return n._logger.error("Unable to initialize active tracks",e),i(e)})},d.prototype.fetchNChunks=function(i,n){if(t.isNumber(i,"chunksToFetch"),t.isFunction(n,"done"),this.isFetchingData())return this._logger.debug("Unable to fetch requesting data. Feeder is already fetching data.");var r=this,a=0;r._logger.debug("Fetching [%s] chunks for [%s] active tracks",i,this._activeTracks.length),e.forEach(this._activeTracks,function(e){t.isInstanceOf(e,o,"track");var i=Math.min(Math.floor(r._bufferSize/e.getChunkDuration),1);return e.setCurrentChunkId(h.call(r,e.getChunkDuration())),y.call(r,e,i,null,function(t){return t?(r._logger.warn("Failed to get [%s] chunks for track [%s]",i,e.getTrackId(),t),n(t)):++a===r._activeTracks.length?(r._logger.info("Got [%s] chunks for [%s] active tracks",i,r._activeTracks.length),n()):void 0})})},d.prototype.setActiveTracks=function(e){this._activeTracks=e},d.prototype.getActiveTracks=function(){return this._activeTracks},d.prototype.startRequestingDataForActiveTracks=function(){if(this.isFetchingData())return this._logger.debug("Unable to start requesting data. Feeder is already fetching data.");this._keepFetchingData=!0,this._logger.debug("Starting requesting data at timestamp [%s]",this._currentPlaybackTimeInSeconds),g.call(this),p.call(this,null)},d.prototype.isFetchingData=function(){return this._keepFetchingData},d.prototype.seekToChunk=function(e){this._currentPlaybackTimeInSeconds=Math.floor(e),this._logger.debug("Seeking to timestamp [%s]",this._currentPlaybackTimeInSeconds),g.call(this)},d.prototype.seekToCurrent=function(){var t=e.reduce(this._activeTracks,function(e,t){return t.getChunkDuration()>e?t.getChunkDuration():e},0),i=(Math.max(this._playlist.getPlaybackDurationSinceAvailable(),0)-Math.max(this._targetLatencyInMilliseconds?this._targetLatencyInMilliseconds:0,t))/1e3;return this._logger.info("Seeking to most recent chunk"),this.seekToChunk(i),i},d.prototype.stopRequestingAllData=function(){this._keepFetchingData&&(this._keepFetchingData=!1,this._logger.debug("Pausing requesting of data at timestamp [%s]",this._currentPlaybackTimeInSeconds),this._httpRequestManager.disposePendingRequests())},d}.apply(t,n))&&(e.exports=r)},function(e,t,i){var n,r;n=[i(1),i(0),i(10),i(4)],void 0!==(r=function(e,t,i,n){"use strict";function r(e){t.isObject(e,"logger"),this._logger=e,this._requestDisposables=new n.DisposableList}return r.prototype.toString=function(){return"HttpRequestManager"},r.prototype.disposePendingRequests=function(){this._requestDisposables.dispose(),this._requestDisposables=new n.DisposableList},r.prototype.dispose=function(){this.disposePendingRequests()},r.prototype.getWithRetry=function(n,r,a){t.isStringNotEmpty(n,"url"),t.isObject(r,"options"),t.isFunction(a,"callback");var s=this;r.retryOptions=e.assign({delay:0,backoff:1,maxAttempts:1,additionalRetryErrorCodes:[404,0]},r.retryOptions),this._requestDisposables.add(i.getWithRetry(n,r,function(e,t){return e&&4e3===e.code?s._logger.debug("Request handler disposed of before response received for get [%s]",n):(e&&s._logger.debug("Status code: [%s] (status text: [%s]) for get [%s]",e.code,e.message,n),a(e,t))}))},r}.apply(t,n))&&(e.exports=r)},function(e,t,i){var n,r;n=[i(1),i(0),i(2),i(3),i(16),i(12),i(5),i(7),i(9),i(14),i(6)],void 0!==(r=function(e,t,i,n,r,a,s,o,l,u,c){"use strict";function d(a,o,l,c){t.isInstanceOf(o,s,"playlist"),t.isInstanceOf(o.parsedPlaylist,u,"playlist.parsedPlaylist"),t.isStringNotEmpty(o.playlistUrl,"playlist.playlistUrl"),t.isStringNotEmpty(o.baseUrl,"playlist.baseUrl"),c&&c.targetLatencyInMilliseconds&&t.isNumber(c.targetLatencyInMilliseconds,"options.targetLatencyInMilliseconds"),this._playlist=o,this._baseUrl=this._playlist.baseUrl,this._statsProvider=l,this._logger=a||new i.Logger,this._httpRequestManager=new r(this._logger),this._options=c,this._feederErrorEvent=new n.Event,this._activeTracks=[],this._currentPlaybackTimeInSeconds=0,this._keepFetchingData=!1,this._targetLatencyInMilliseconds=e.get(c,"targetLatencyInMS",0),this._minBufferSize=Math.max(this._playlist.getSuggestedPresentationDelayTotalMillis(),this._playlist.getMinBufferTimeTotalMillis(),this._defaultPresentationDelay),this._streamDurationBeforeInitialization=Math.max(this._playlist.getPlaybackDurationSinceAvailable()-this._minBufferSize,0)}function h(){var t=this;e.isNumber(t._mediaSegmentRequestTimeout)||(t._mediaSegmentRequestTimeout=setTimeout(function(){(function(t){var i=this,n=0;e.forEach(this._activeTracks,function(r){var a=r.getMediaSegmentPlaylistUrlInfo(),s=e.assign({version:e.now()},a.queryParameters),o={retryOptions:{delay:v,maxAttempts:b},queryParameters:s};i._httpRequestManager.getWithRetry(a.url,o,function(e,s){if(e)return i._logger.debug("Unable to get media segment playlist [%s]",a.url);s&&r.updateMediaSegments(s.data),++n===i._activeTracks.length&&t()})},_)}).call(t,function(){e.isNullOrUndefined(t._mediaSegmentRequestTimeout)||(t._mediaSegmentRequestTimeout=null,h.call(t))})},_))}function g(t){var i=this,n=i._activeTracks.length;i._waitingForNextSegment=!1;e.forEach(i._activeTracks,function(r,a){!function(r){e.find(i._activeTracks,function(e){return e.getMimeType()===r.getMimeType()})!==r?i._logger.debug("Wrong track type [%s]. Pausing fetching for track [%s]",r.getMimeType(),r.getTrackId()):r.isLastMediaSegment(i._currentPlaybackTimeInSeconds)?("dynamic"===i._playlist.getType()&&(i._waitingForNextSegment=!0),i._logger.debug("No more chunks. Pausing fetching for track [%s]",r.getMimeType(),r.getTrackId())):f.call(i,r,1,t,function(e){if(e&&e.causes&&e.causes.length>0&&"not yet available"===e.causes[0].feederReason?i._logger.info("Failed to get next chunk (packet not yet available) for [%s]|[%s]. Trying to fetch again in [%s] ms.",r.getMseCodec(),r.getBandwidth(),y):(e&&i._logger.warn("Failed to get next chunk (# of errors=[%s], errors=[%s]). Moving on.",e.causes?e.causes.length:"n/a",JSON.stringify(e)),n--),n<=0){i._logger.debug("Done fetching chunk for timestamp [%s] for each active track. Moving on to next chunk. (keep fetching=[%s])",i._currentPlaybackTimeInSeconds,i._keepFetchingData);var t=r.isLastMediaSegment(i._currentPlaybackTimeInSeconds);if("static"===i._playlist.getType()&&t)return i._keepFetchingData=!1,i._logger.info("Finished getting chunks for [static] track [%s] [%s]",r.getTrackId(),r.getMimeType());if(t)return i._waitingForNextSegment=!0,i._logger.debug("Waiting for new segment on the Segment Playlist for [dynaimic] track [%s] [%s]",r.getTrackId(),r.getMimeType());i._keepFetchingData&&g.call(i,null)}})}(r)})}function f(t,i,n,r){var a=this;(function(t,i,n){var r=this,a=t.getSegmentByTimestamp(r._currentPlaybackTimeInSeconds),s=r._baseUrl+a.name;r._logger.trace("Fetching data chunk for [%s]: [%s], next segment=[%s]",t.getMseCodec(),s,a.name);var o=t.getMseCodec();(function(t,i,n){var r=this,a={responseType:"arraybuffer",retryOptions:{delay:y,maxAttempts:m},timeout:k};if(e.isNumber(i))a.delay=i;else if(!e.isNullOrUndefined(i))throw new Error('"delay" must be a number or null or undefined');return this._httpRequestManager.getWithRetry(t,a,function(i,a){if(i){if(r._logger.debug("Failed to load next stream data chunk. Status code: [%s] (status text: [%s]) for [%s]",i.code,i.message,t),a&&a.attempts===m){var s="Failed to get chunk with max retries of ["+m+" after ["+e.get(a,["stats","totalResponseTimeForAllAttempts"],0)+"] ms";return r._feederErrorEvent.fire([p(c.name.chunkNotFound.name,c.severity.CRITICAL,s)])}if(0===i.code){var o="Failed to get chunk with timeout after ["+e.get(a,["stats","totalResponseTimeForAllAttempts"],0)+"] ms with chunk timeout of ["+k+"]";return r._feederErrorEvent.fire([p(c.name.timeout.name,c.severity.RECOVERABLE,o)])}return r._feederErrorEvent.fire([p(c.name.error.name,c.severity.CRITICAL,i)])}n(i,a)})}).call(r,s,i,function(e,i){if(r._logger.trace("DONE Fetching data chunk for [%s] : [%s], next segment=[%s]",o,s,a.name+(e?": FAILED: "+e.code:": data="+i.data.byteLength)),e||r._statsProvider.addRateDataPoint(o,i.stats.successResponseTime,i.data.byteLength,.001),!e)return r._logger.debug("Finished fetching [%s]. Updating timestamp to fetch to [%s]",a.name,a.timestamp+a.duration),r._currentPlaybackTimeInSeconds=a.timestamp+a.duration,t.addDataChunk(i.data,a.name,function(){n(e)});e?(e.feederReason=404===e.code?"not yet available":"other",n(e)):n(null,i.data)})}).call(a,t,n,function(e){return e&&a._logger.trace('Failed to fetch data chunk of stream for config [%s]". Error: [%s]',JSON.stringify(t),e),!e&&i>1&&f.call(a,t,i,n,r),r(e)})}function p(e,t,i){return{category:c.category.STREAMING,name:e,severity:t,error:"Error"===i.constructor.name?i:new Error(i)}}var m=15,y=700,_=500,v=10,b=2,k=5e3;return d.prototype=Object.create(a.prototype),d.prototype.constructor=d,d.prototype.toString=function(){return"M3u8PlaylistChunkFeeder [mpdPlaylistUrl="+this._playlist.playlistUrl+", baseUrl="+this._baseUrl+", defaultPresentationDelay="+this._defaultPresentationDelay+"]"},d.prototype.addEventListener=function(e,i){switch(t.isString(e,"eventName"),t.isFunction(i,"listener"),e){case"error":return this._feederErrorEvent.listen(i);default:throw new Error('Event "'+e+'" is unknown.')}},d.prototype.dispose=function(){this.stopRequestingAllData(e.noop),this._httpRequestManager.dispose(),this._playlist.dispose(),this._statsProvider.dispose(),this._activeTracks=null,this._currentPlaybackTimeInSeconds=0,this._segmentsReadyDisposable&&(this._segmentsReadyDisposable.dispose(),this._segmentsReadyDisposable=null)},d.prototype.initializeActiveTracks=function(i,n){t.isFunction(n,"callback"),"dynamic"===this._playlist.getType()&&h.call(this),this._waitingForNextSegment=!1;var r=this;if(1!==this._activeTracks.length)throw new Error("Unable to support multiple active tracks");e.forEach(this._activeTracks,function(e){r._segmentsReadyDisposable=e.addEventListener("segmentsready",function(){r._waitingForNextSegment&&(r._logger.debug("Continuing fetching of track [%s] segments after wait",e.getTrackId()),g.call(r,null))})}),n()},d.prototype.fetchNChunks=function(i,n){if(t.isNumber(i,"chunksToFetch"),t.isFunction(n,"callback"),this.isFetchingData())return this._logger.debug("Unable to fetch requesting data. Feeder is already fetching data.");var r=this,a=0;r._logger.debug("Fetching [%s] chunks for [%s] active tracks",i,this._activeTracks.length),e.forEach(this._activeTracks,function(t){f.call(r,t,1,null,function(t){if(t)return n(t);++a===r._activeTracks.length&&(r._initializedAt=e.now(),n())})})},d.prototype.setActiveTracks=function(t){this._activeTracks=t;var i=e.map(t,function(e){return e.getTrackId()});this._logger.debug("Setting active tracks [%s]",i)},d.prototype.getActiveTracks=function(){return this._activeTracks},d.prototype.startRequestingDataForActiveTracks=function(){if(this.isFetchingData())return this._logger.debug("Unable to start requesting data. Feeder is already fetching data.");this._keepFetchingData=!0,this._logger.debug("Starting requesting data at timestamp [%s]",this._currentPlaybackTimeInSeconds),"dynamic"===this._playlist.getType()&&h.call(this),g.call(this,null)},d.prototype.isFetchingData=function(){return this._keepFetchingData},d.prototype.seekToChunk=function(t){var i=e.get(this._activeTracks,["0"]),n=i.getClosestSegmentNotGreaterThanTimestamp(t),r=e.get(n,["timestamp"]);e.isUndefined(r)?i||(this._currentPlaybackTimeInSeconds=t):this._currentPlaybackTimeInSeconds=Math.floor(n.timestamp),this._logger.debug("Seeking to timestamp [%s]",this._currentPlaybackTimeInSeconds)},d.prototype.seekToCurrent=function(){var t=e.reduce(this._activeTracks,function(t,i){var n=e.get(i.getLastSegment(),["duration"],0);return n>t?n:t},0),i=(e.reduce(this._activeTracks,function(e,t){var i=t.getLastSegment().timestamp;return i<e?i:e},0)-Math.max(this._targetLatencyInMilliseconds?this._targetLatencyInMilliseconds-t:0,t))/1e3;return this._logger.info("Seeking to most recent chunk"),this.seekToChunk(i),i},d.prototype.stopRequestingAllData=function(){this._keepFetchingData&&(this._keepFetchingData=!1,this._waitingForNextSegment=!1,this._logger.debug("Pausing requesting of data at timestamp [%s]",this._currentPlaybackTimeInSeconds),this._httpRequestManager.disposePendingRequests(),clearTimeout(this._mediaSegmentRequestTimeout),this._mediaSegmentRequestTimeout=null)},d}.apply(t,n))&&(e.exports=r)},function(e,t,i){var n,r;n=[i(1),i(0),i(2),i(3),i(10),i(4),i(11),i(8),i(6)],void 0!==(r=function(e,t,i,n,r,a,s,o,l){"use strict";function u(r,s,u,h){t.isObject(s,"videoElement");var D=this;this._videoElement=s,this._logger=r||new i.Logger,this._mediaKeys=null,this._licenseRequestRetryTimeout=null,this._certificateRequestRetryTimeout=null,this._disposables=new a.DisposableList;var M=e.bind(C,this);"Safari"===m.browser&&(M=e.bind(function(t,i){var n=this;if(i=i||1,!this._fairplayServerCertificate){if(i<=T)return n._logger.debug("Attempt [%s] for checking if the certificate have been set",i),void(n._certificateRequestRetryTimeout=setTimeout(function(){C.call(n,t,i+1)},w));var r="Unable to find fairplay certificate after "+(i-1)+" attempts";return n._logger.warn(r),n._drmErrorEvent.fire([p("NoCertificate",l.severity.RECOVERABLE,r)])}this._logger.info("Key requested by Webkit browser"),n._fallbackLicenseUri=function(e){return"https://"+function(e){return String.fromCharCode.apply(null,new o.global.Uint16Array(e.buffer))}(e).split("skd://")[1]}(t.initData);var s="phenix-fairplay-"+e.now(),u=function(e,t,i){var n=function(e){for(var t=new o.global.ArrayBuffer(2*e.length),i=new o.global.Uint16Array(t),n=0,r=e.length;n<r;n++)i[n]=e.charCodeAt(n);return i}(t),r=0,a=new o.global.ArrayBuffer(e.byteLength+4+n.byteLength+4+i.byteLength),s=new o.global.DataView(a);new Uint8Array(a,r,e.byteLength).set(e),r+=e.byteLength,s.setUint32(r,n.byteLength,!0),r+=4;var l=new o.global.Uint16Array(a,r,n.length);return l.set(n),r+=l.byteLength,s.setUint32(r,i.byteLength,!0),r+=4,new Uint8Array(a,r,i.byteLength).set(i),new Uint8Array(a,0,a.byteLength)}(t.initData,s,n._fairplayServerCertificate);n._videoElement.webkitKeys||n._videoElement.webkitSetMediaKeys(new o.global.WebKitMediaKeys(b));if(!n._videoElement.webkitKeys)return n._drmErrorEvent.fire([p("webkitKeys",l.severity.RECOVERABLE,new Error("Could not create MediaKeys"))]);var c=n._videoElement.webkitKeys.createSession("video/mp4",u);if(!c)return n._drmErrorEvent.fire([p("webkitKeySession",l.severity.RECOVERABLE,new Error("Could not create key session"))]);var h=e.bind(d,n);c.addEventListener("webkitkeymessage",h,!1),n._disposables.add(new a.Disposable(function(){c.removeEventListener("webkitkeymessage",h,!1)}));var g=function(){n._logger.info("Decryption key was added")};c.addEventListener("webkitkeyadded",g,!1),n._disposables.add(new a.Disposable(function(){c.removeEventListener("webkitkeyadded",g,!1)}));var f=function(e){n._drmErrorEvent.fire([p("webkitkeyerror",l.severity.RECOVERABLE,e)])};c.addEventListener("webkitkeyerror",f,!1),n._disposables.add(new a.Disposable(function(){c.removeEventListener("webkitkeyerror",f,!1)}))},this)),this._videoElement.addEventListener(S,M,!1),this._disposables.add(new a.Disposable(function(){D._videoElement.removeEventListener(S,M,!1)})),this._disposables.add(new a.Disposable(function(){null!==D._licenseRequestRetryTimeout&&o.global.clearTimeout(D._licenseRequestRetryTimeout)})),this._disposables.add(new a.Disposable(function(){null!==D._certificateRequestRetryTimeout&&o.global.clearTimeout(D._certificateRequestRetryTimeout)})),this._defaultMediaKeySystemConfig={initDataTypes:["cenc"],videoCapabilities:[{contentType:'video/mp4; codecs="avc1.42c01f"'}],audioCapabilities:[{contentType:'audio/mp4; codecs="mp4a.40.2"'}],persistentState:"optional",distinctiveIdentifier:"optional"},this._config={},"Edge"===m.browser||"IE"===m.browser?this._selectedKeySystem=_:"Safari"===m.browser?this._selectedKeySystem=b:this._selectedKeySystem=y,function(t,i){var n=this,r=function(t){return e.keys(e.reduce(t,function(e,t){return e[t]=1,e},{}))}(e.keys(t).concat(e.keys(i)));e.forEach(r,function(r){e.set(n._config,[r],e.assign({},e.get(t,[r],{}),e.get(i,[r],{}))),e.set(n._config,[r,"mediaKeySystemConfiguration"],e.assign({},n._defaultMediaKeySystemConfig,e.get(t,[r,"mediaKeySystemConfiguration"],{}),e.get(i,[r,"mediaKeySystemConfiguration"],{})))})}.call(this,function(t){return e.reduce(t,function(t,i){var n="com.phenixp2p.widevine"===i.schemeIdUri||"com.phenixrts.widevine"===i.schemeIdUri?y:i.schemeIdUri===v?_:i.schemeIdUri,r="",a="";return"com.phenixp2p.widevine"!==i.schemeIdUri&&"com.phenixrts.widevine"!==i.schemeIdUri||(r=i.widevineLicenseServerUrl||i.licenseServerUrl,a=i.serverCertificateUrl),t[n]={licenseServerUrl:r?c(r):"",serverCertificateUrl:a?c(a):""},e.forOwn(i,function(i,r){e.startsWith(r,"mediaKeySystemConfiguration.")&&e.set(t[n],r,i)}),t},{})}(u),h||{}),function(){t.isObject(this._config,"this._config");var i=this;e.forOwn(this._config,function(e,n){t.isValidType(n,k,n),n===i._selectedKeySystem&&(n!==y&&n!==b||t.isStringNotEmpty(e.serverCertificateUrl,n+"[serverCertificateUrl]"),t.isObject(e.mediaKeySystemConfiguration,n+"[mediaKeySystemConfiguration]"),t.isArrayOfString(e.mediaKeySystemConfiguration.initDataTypes,n+"[mediaKeySystemConfiguration][initDataTypes]"),t.isArray(e.mediaKeySystemConfiguration.videoCapabilities,n+"[mediaKeySystemConfiguration][videoCapabilities]"),t.isArray(e.mediaKeySystemConfiguration.audioCapabilities,n+"[mediaKeySystemConfiguration][audioCapabilities]"),t.isStringNotEmpty(e.mediaKeySystemConfiguration.persistentState,n+"[mediaKeySystemConfiguration][persistentState]"),t.isStringNotEmpty(e.mediaKeySystemConfiguration.distinctiveIdentifier,n+"[mediaKeySystemConfiguration][distinctiveIdentifier]"))})}.call(this),this._drmErrorEvent=new n.Event,this._drmTrackEventRestrictionsAvailableEvent=new n.Event,this._disposables.add(this._drmErrorEvent),this._disposables.add(this._drmTrackEventRestrictionsAvailableEvent),E&&function(){var t=this;if(!this._videoElement.mediaKeys){var i=e.get(this._config,[this._selectedKeySystem,"mediaKeySystemConfiguration"]);o.global.navigator.requestMediaKeySystemAccess(this._selectedKeySystem,[i]).then(function(i){i.createMediaKeys().catch(function(e){t._drmErrorEvent.fire([p("CreateMediaKeys",l.severity.CRITICAL,e)]),t._logger.error("Unable to create MediaKeys",e)}).then(function(e){return t._mediaKeys=e,t._videoElement.setMediaKeys(e)}).catch(function(e){t._drmErrorEvent.fire([p("SetMediaKeys",l.severity.CRITICAL,e)]),t._logger.error("Unable to set MediaKeys",e)}).then(function(){return new o.global.Promise(function(i){var n=e.get(t._config,[t._selectedKeySystem,"serverCertificateUrl"]);if(!n)return t._logger.info("Not fetching server certificate because [%s] -> [serverCertificateUrl] is not set",t._selectedKeySystem),i();g(n,function(e,n){if(e)return t._logger.warn("Failed to get service certificate",e),i();var r=f(n.data);return t._mediaKeys.setServerCertificate(r).then(i).catch(function(e){t._logger.warn("Failed to set service certificate",e)})})})})}).catch(function(e){t._drmErrorEvent.fire([p("RequestMediaKeySystemAccess",l.severity.CRITICAL,e)]),t._logger.error("[%s] Unable to request MediaKeySystemAccess with error [%s]",t._selectedKeySystem,e)})}}.call(this),"Safari"===m.browser&&(o.global.WebKitMediaKeys.isTypeSupported("com.apple.fps.1_0","video/mp4")||D._drmErrorEvent.fire([p("isTypeSupported",l.severity.CRITICAL,new Error("com.apple.fps.1_0 Key System not supported"))]),g(e.get(D._config,[D._selectedKeySystem,"serverCertificateUrl"]),function(e,t){e&&(D._drmErrorEvent.fire([p("getServerCertificateFairplay",l.severity.CRITICAL,e)]),D._logger.error("[Fairplay] Failed to get service certificate",e)),D._fairplayServerCertificate=f(t.data)}))}function c(i){t.isStringNotEmpty(i,"xmlSafeUrl");var n=i.split("?"),r=e.get(n,[0]),a=e.get(n,[1],"");return r+(a?"?"+decodeURIComponent(a):"")}function d(t){var i=this,n=t.target;h.call(this,t.message,function(t,r){if(t)return i._drmErrorEvent.fire([p("LicenseRetrieval",l.severity.RECOVERABLE,t)]);try{var a=n.update(r)}catch(e){return i._drmErrorEvent.fire([p("KeySessionUpdate",l.severity.CRITICAL,e)])}e.isFunction(e.get(a,["catch"]))&&a.catch(function(e){i._drmErrorEvent.fire([p("KeySessionUpdate",l.severity.CRITICAL,e)]),i._logger.error("Update of keySession with license failed [%s]",e)})})}function h(i,n){var a,s=this,l=e.get(this._config,[this._selectedKeySystem,"licenseServerUrl"],this._fallbackLicenseUri),u={};if(t.isStringNotEmpty(l,"licenseServerUrl"),this._selectedKeySystem===_){var c=(new DOMParser).parseFromString(String.fromCharCode.apply(null,new o.global.Uint16Array(i)),"application/xml");if(!c.getElementsByTagName("Challenge")[0])return n(new Error("[Playready] Cannot find `challenge` in key message"));a=atob(c.getElementsByTagName("Challenge")[0].childNodes[0].nodeValue);var d=c.getElementsByTagName("name"),h=c.getElementsByTagName("value");if(d.length!==h.length)return n(new Error("[Playready] Mismatched header name/value pair in key message"));u.headers={};for(var g=0;g<d.length;g++){var f=e.get(d,[g,"childNodes",0,"nodeValue"]),p=e.get(h,[g,"childNodes",0,"nodeValue"]);f&&p&&(u.headers[f]=p)}u.responseType="arraybuffer"}else u.contentType="application/octet-stream",a=i;r.post(l,a,u,function(e,t){if(e)return s._logger.error("Failed to get license with [%s] [%s]",e,t),n(e);if(s._selectedKeySystem===_)return n(null,t.data);var i=t.data,r=null,a=null;try{s._logger.debug("Attempting to unwrap license response"),r=(i=JSON.parse(i)).license||i.ckc,i.trackRestrictions&&s._drmTrackEventRestrictionsAvailableEvent.fire([i.trackRestrictions])}catch(e){if(!(e instanceof SyntaxError))return s._logger.error("Unexpected error [%s]",e),n(e);s._logger.debug("Unwrapping of license failed. Assuming that license response is already unwrapped"),r=i}"<ckc>"===r.substr(0,5)&&"</ckc>"===r.substr(-6)&&(r=r.slice(5,-6));try{a=function(e){for(var t=o.global.atob(e),i=new Uint8Array(t.length),n=0;n<t.length;++n)i[n]=t.charCodeAt(n);return i}(r)}catch(e){s._logger.error("Failed to convert base64 license string [%s] to binary",r),n(e)}n(null,a)})}function g(e,t){r.get(e,{mimeType:"text/plain; charset=x-user-defined"},t)}function f(e){for(var t=e.length,i=new o.global.Uint8Array(t),n=0;n<t;n++)i[n]=e.charCodeAt(n);return i}function p(e,t,i){return{category:l.category.DRM,name:e,severity:t,error:"Error"===i.constructor.name?i:new Error(i)}}var m=new s(o.global.navigator.userAgent).detect(),y="com.widevine.alpha",_="com.microsoft.playready",v="urn:uuid:9a04f079-9840-4286-ab92-e65be0885f95",b="com.apple.fps.1_0",k=e.freeze([{id:1,name:"org.w3.clearkey"},{id:2,name:y},{id:3,name:_},{id:4,name:v},{id:5,name:b}]),w=200,T=20,E=!!o.global.navigator.requestMediaKeySystemAccess,S="encrypted";E||"Edge"!==m.browser&&"IE"!==m.browser||(S="msneedkey"),"Safari"===m.browser&&(S="webkitneedkey"),u.isSupported=function(){return"IE"===m.browser&&11===m.version||("Safari"===m.browser?!(e.isNullOrUndefined(o.global.WebKitMediaKeys)||e.isNullOrUndefined(o.global.Uint16Array)||e.isNullOrUndefined(o.global.Uint8Array)||e.isNullOrUndefined(o.global.ArrayBuffer)||e.isNullOrUndefined(o.global.DataView)):!(e.isNullOrUndefined(o.global.navigator.requestMediaKeySystemAccess)||e.isNullOrUndefined(o.global.Promise)||e.isNullOrUndefined(o.global.Uint8Array)||e.isNullOrUndefined(o.global.atob)))},u.prototype.addEventListener=function(e,i){switch(t.isString(e,"eventName"),t.isFunction(i,"listener"),e){case"trackRestrictionsAvailable":return this._drmTrackEventRestrictionsAvailableEvent.listen(i);case"error":return this._drmErrorEvent.listen(i);default:throw new Error('Event "'+e+'" is unknown.')}},u.prototype.toString=function(){return"EncryptedMediaHandler [config="+JSON.stringify(this._config)+"]"},u.prototype.dispose=function(){this._disposables.dispose(),delete this._mediaKeys};var C=function(t,i){var n=this;if(i=i||1,!E)try{this._videoElement.msSetMediaKeys(new o.global.MSMediaKeys(this._selectedKeySystem))}catch(r){return n._drmErrorEvent.fire([p("RequestMediaKeySystemAccess",l.severity.CRITICAL,new Error('Unable to create MediaKeys ("'+this._selectedKeySystem+'"). Error: '+r.message))])}if(!this._mediaKeys&&!n._videoElement.msKeys){if(i<=20)return n._logger.debug("Attempt [%s] for checking if the media keys have been set",i),void(n._licenseRequestRetryTimeout=setTimeout(function(){C.call(n,t,i+1)},w));var r="Unable to find media keys after "+(i-1)+" attempts";return n._logger.warn(r),n._drmErrorEvent.fire([p("NoMediaKeys",l.severity.RECOVERABLE,r)])}if(n._videoElement.msKeys){var s=n._videoElement.msKeys.createSession("video/mp4",t.initData);s||n._drmErrorEvent.fire([p("NoKeySession",l.severity.CRITICAL,new Error("Could not create key session"))]);var u=function(e){h.call(n,e.message.buffer,function(e,t){if(e)return n._drmErrorEvent.fire([p("getLicense",l.severity.RECOVERABLE,e)]);s.update(new Uint8Array(t))})};s.addEventListener("mskeymessage",u,!1),n._disposables.add(new a.Disposable(function(){s.removeEventListener("mskeymessage",u,!1)}));var c=function(){n._drmErrorEvent.fire([p("MicrosoftKeyError",l.severity.CRITICAL,new Error("Unexpected `keyerror` event from key session. Code: "+s.error.code+", systemCode: "+s.error.systemCode))])};return s.addEventListener("mskeyerror",c,!1),void n._disposables.add(new a.Disposable(function(){s.removeEventListener("mskeyerror",c,!1)}))}var g=n._mediaKeys.createSession(),f=e.bind(d,n);return g.addEventListener("message",f,!1),n._disposables.add(new a.Disposable(function(){g.removeEventListener("message",f,!1)})),g.generateRequest(t.initDataType,t.initData).then(function(){n._logger.info("passing the media data to CDM")}).catch(function(e){n._drmErrorEvent.fire([p("InitKeySessionFailure",l.severity.CRITICAL,e)]),n._logger.error("Unable to create or initialize key session [%s]",e)})};return u}.apply(t,n))&&(e.exports=r)},function(e,t){e.exports=l},function(e,t,i){var n,r;n=[i(1),i(0),i(2),i(4),i(19),i(5),i(9)],void 0!==(r=function(e,t,i,n,r,a,s){"use strict";function o(o,h,m,y){t.isInstanceOf(h,a,"playlist"),t.isNotUndefined(m,"webPlayer"),t.isInstanceOf(y,s,"statsProvider"),this._playlist=h,this._webPlayer=m,this._statsProvider=y,this._logger=o||new i.Logger,this._bandwidthChangeDetails={nextSwitchCheckTime:e.now()+5e3,oldBandwidth:-1},this._disposables=new n.DisposableList,this._webPlayer.addEventListener("started",e.bind(function(){var t=this;this._bandwidthLimits=e.reduce(this._playlist.getMimeTypes(),function(i,n){var r=t._playlist.getPlaylistTracksByMimeType(n)||[],a=e.filter(r,function(t){return e.isNumber(t.getBandwidth())}),s=e.map(a,function(e){return e.getBandwidth()});return r.length>a.length&&t._logger.info("Excluding [%s] tracks without Bandwidth from ABR switching.",r.length-a.length),i[n]={max:Math.max.apply(null,s),min:Math.min.apply(null,s)},i},{}),this._logger.debug("Listening for bandwidth changes with max and min bandwidths of [%s]",this._bandwidthLimits),this._webPlayer.addEventListener("playbacktimeleft",e.bind(function(t,i){if(this._bandwidthChangeDetails.isInProgress||!r.isForeground())return;var n=this._bandwidthLimits[i.getMimeType()],a=this;if(this._bandwidthChangeDetails.nextSwitchCheckTime>0){if(this._bandwidthChangeDetails.nextSwitchCheckTime>e.now())return;this._bandwidthChangeDetails.nextSwitchCheckTime=0,this._bandwidthChangeDetails.oldBandwidth=-1}var s=e.bind(function(){this._bandwidthChangeDetails.isInProgress=!1},this);if(l.call(a,i,t)&&i.getBandwidth()<n.max){this._bandwidthChangeDetails.isInProgress=!0;var o=this._playlist.getPlaylistTrackByMimeTypeAndNextHighestBandwidth(i.getBandwidth(),i.getMimeType());this._playbackTimeout=setTimeout(function(){l.call(a,i,a._webPlayer.getTimeLeft())?(a._logger.info("Switching to higher quality track with [%s] time left in buffer and ewma of [%s].",a._webPlayer.getTimeLeft(),c.call(a,i)),a._bandwidthChangeDetails.nextSwitchCheckTime=e.now()+1e3*t+g,a._bandwidthChangeDetails.oldBandwidth=i.getBandwidth(),a._webPlayer.changeBandwidthLimit(o.getBandwidth(),s)):a._bandwidthChangeDetails.isInProgress=!1},p)}else if(u.call(a,i,t)&&i.getBandwidth()>n.min){this._bandwidthChangeDetails.isInProgress=!0;var d=this._playlist.getPlaylistTrackByBandwidthAndMimeType(i.getBandwidth()-1,i.getMimeType());this._playbackTimeout=setTimeout(function(){u.call(a,i,a._webPlayer.getTimeLeft())?(a._logger.info("Switching to lower quality track with [%s] time left in buffer and ewma of [%s].",a._webPlayer.getTimeLeft(),c.call(a,i)),a._bandwidthChangeDetails.nextSwitchCheckTime=e.now()+1e3*t+f,a._bandwidthChangeDetails.oldBandwidth=i.getBandwidth(),a._webPlayer.changeBandwidthLimit(d.getBandwidth(),s)):a._bandwidthChangeDetails.isInProgress=!1},p)}},this))},this)),this._disposables.add(r.onBackground(e.bind(d,this,!1))),this._disposables.add(r.onForeground(e.bind(d,this,!0))),this._backgroundTimeout=null,this._foregroundBandwidth=null}function l(e,t){var i=this._statsProvider.getRateAverages(e.getMseCodec()).ewmaDuration,n=e.getChunkDuration();return t>3.5||i>0&&i<=3*n/4&&t/(n/1e3)>2}function u(e,t){var i=this._statsProvider.getRateAverages(e.getMseCodec()).ewmaDuration,n=e.getChunkDuration();return t<.7||i>0&&i>=7*n/8&&t/(n/1e3)<=1.5}function c(e){return this._statsProvider.getRateAverages(e.getMseCodec()).ewmaDuration}function d(t){null!==this._playbackTimeout&&(clearTimeout(this._playbackTimeout),this._playbackTimeout=null);var i=this._webPlayer.getVideoElement();if(t){if(clearTimeout(this._backgroundTimeout),this._backgroundTimeout=null,null===this._foregroundBandwidth)return;var n=this._foregroundBandwidth;return this._foregroundBandwidth=null,n!==this._webPlayer.getBandwidthLimit()&&(this._bandwidthChangeDetails.nextSwitchCheckTime=e.now()+g,this._logger.info("Detected change to [foreground] for tab. Reverting to [%s] previous bandwidth limit from [%s]",n,this._webPlayer.getBandwidthLimit()),this._webPlayer.changeBandwidthLimit(n)),void(h(i)||"dynamic"!==this._playlist.getType()||(this._logger.info("Detecting application [foreground] with muted video. Resuming playback at most recent available chunk."),this._webPlayer.play()))}var a=this;this._backgroundTimeout=setTimeout(function(){r.isForeground()||(a._foregroundBandwidth=a._webPlayer.getBandwidthLimit(),h(i)||"dynamic"!==a._playlist.getType()||(a._logger.info("Detecting application [background] with muted video. Pausing playback until application focused again."),a._webPlayer.pause()))},m)}function h(t){return!t.muted&&0!==t.volume&&(e.get(t,["webkitAudioDecodedByteCount"],0)>0||e.get(t,["audioTracks","length"],0)>0||t.mozHasAudio||t.hasAudio||t.webkitHasAudio)}var g=15e3,f=5e3,p=500,m=3e3;return o.prototype.dispose=function(){null!==this._playbackTimeout&&clearTimeout(this._playbackTimeout),null!==this._backgroundTimeout&&clearTimeout(this._backgroundTimeout),this._disposables.dispose(),this._backgroundTimeout=null,this._playbackTimeout=null},o}.apply(t,n))&&(e.exports=r)},function(e,t,i){"use strict";var n,r;n=[i(5),i(15),i(17),i(27),i(9),i(20),i(6)],void 0!==(r=function(e,t,i,n,r,a,s){return{Playlist:e,MpdPlaylistChunkFeeder:t,M3u8PlaylistChunkFeeder:i,WebPlayer:n,StatsProvider:r,AdaptiveStreamingManager:a,isSupported:n.isSupported,errors:s}}.apply(t,n))&&(e.exports=r)},function(e,t,i){var n,r;n=[i(0),i(3),i(2),i(7)],void 0!==(r=function(e,t,i,n){"use strict";function r(n,r,o){if(e.isObject(n,"logger"),e.isObject(r,"playlistTrackConfig"),e.isStringNotEmpty(r.codec,"playlistTrackConfig.codec"),e.isStringNotEmpty(r.mimeType,"playlistTrackConfig.mimeType"),e.isNumber(r.bandwidth,"playlistTrackConfig.bandwidth"),e.isNumber(r.chunkDuration,"playlistTrackConfig.chunkDuration"),e.isStringNotEmpty(r.trackId,"playlistTrackConfig.trackId"),e.isStringNotEmpty(r.initUrl,"playlistTrackConfig.initUrl"),e.isStringNotEmpty(r.dataChunkUrlTemplate,"playlistTrackConfig.dataChunkUrlTemplate"),e.isNumber(r.chunkDuration,"playlistTrackConfig.chunkDuration"),o=o||{},this._logger=n||new i.Logger,this._mseCodec=r.codec,this._chunkDuration=r.chunkDuration,this._bandwidth=r.bandwidth,this._height=r.height,this._trackId=r.trackId,this._mimeType=r.mimeType,this._initUrl=r.initUrl,this._dataChunkUrlTemplate=r.dataChunkUrlTemplate,this._totalNumberOfChunks=r.totalNumberOfChunks,this._currentChunkId=null,this._maxChunksToCache=o.maxChunksToCache||a,this._lowWaterMaxChunks=o.lowWaterMaxChunks||s,e.isNumber(this._maxChunksToCache,"options.maxChunksToCache"),e.isNumber(this._lowWaterMaxChunks,"options.lowWaterMaxChunks"),this._lowWaterMaxChunks>=this._maxChunksToCache)throw new Error('The "maxChunksToCache" cannot be less than or equal to the "lowWaterMaxChunks"');this._initChunk=null,this._dataChunks=[],this._chunkAddedEvent=new t.Event}var a=20,s=15;return r.prototype=Object.create(n.prototype),r.prototype.constructor=r,r.prototype.toString=function(){return"MpdPlaylistTrack [mseCodec="+this._mseCodec+", maxChunksToCache="+this._maxChunksToCache+", lowWaterMaxChunks="+this._lowWaterMaxChunks+", initChunk="+this._initChunk+", dataChunks(size)="+this._dataChunks.length+", chunkAddedEvent(size)="+this._chunkAddedEvent.size()+", trackId="+(this._trackId?this._trackId:"n/a")+", bandwidth="+(this.bandwidth?this.bandwidth:"n/a")+"]"},r.prototype.dispose=function(){this._dataChunks=[],this._chunkAddedEvent.dispose()},r.prototype.getMseCodec=function(){return this._mseCodec},r.prototype.getTrackId=function(){return this._trackId},r.prototype.getChunkDuration=function(){return this._chunkDuration},r.prototype.getBandwidth=function(){return this._bandwidth},r.prototype.getHeight=function(){return this._height},r.prototype.getMimeType=function(){return this._mimeType},r.prototype.getTotalNumberOfChunks=function(){return this._totalNumberOfChunks},r.prototype.getInitChunkData=function(){return this._initChunk},r.prototype.setInitChunkData=function(e){this._initChunk=e},r.prototype.getCurrentChunkId=function(){return this._currentChunkId},r.prototype.setCurrentChunkId=function(e){this._currentChunkId=e},r.prototype.incrementCurrentChunkId=function(){null===this._currentChunkId&&this._logger.error("[%s] Attempting to increment `CurrentChunkId` that is not initialized",this._trackId),this._currentChunkId++},r.prototype.getInitUrl=function(){return this._initUrl},r.prototype.getDataChunkUrlTemplate=function(){return this._dataChunkUrlTemplate},r.prototype.addDataChunk=function(t,i,n){e.isNotUndefined(t,"dataChunk"),n=n||function(){},e.isFunction(n,"eventCallback");var r={data:t,chunkId:i,timestamp:i*this._chunkDuration/1e3};if(this._dataChunks.push(r),this._dataChunks.length>this._maxChunksToCache)for(;this._dataChunks.length>this._lowWaterMaxChunks;)this._dataChunks.shift();this._chunkAddedEvent.fireAsync([r],this,n)},r.prototype.getChunks=function(){return this._dataChunks},r.prototype.addEventListener=function(t,i){if(e.isString(t,"eventName"),e.isFunction(i,"listener"),"chunkadded"!==t)throw new Error('Event "'+t+'" is unknown.');return this._chunkAddedEvent.listen(i)},r}.apply(t,n))&&(e.exports=r)},function(e,t,i){var n,r;n=[i(1),i(0),i(3),i(2),i(7),i(24)],void 0!==(r=function(e,t,i,n,r,a){"use strict";function s(r,a,s){if(t.isObject(r,"logger"),t.isObject(a,"playlistTrackConfig"),t.isStringNotEmpty(a.codecs,"playlistTrackConfig.codecs"),t.isNumber(a.bandwidth,"playlistTrackConfig.bandwidth"),t.isStringNotEmpty(a.trackId,"playlistTrackConfig.trackId"),s=s||{},this._logger=r||new n.Logger,this._mseCodec=function(e){if(e.split(",").length>1)return"video/mp4; codecs="+e;return"audio/mp4; codecs="+e}(a.codecs),this._bandwidth=a.bandwidth,this._height=a.height,this._trackId=a.trackId,this._mimeType=a.mimeType,this._totalNumberOfChunks=a.totalNumberOfChunks,this._mediaSegments=[],this._isComplete=!1,this._playableDuration=0,this._chunkDuration=0,this._mediaSegmentPlaylistUrlInfo=function(t){var i=t.split("?")[0],n=e.get(t.split("?"),[1],""),r=e.reduce(n.split("&"),function(e,t){var i=t.split("=")[0];return i&&(e[i]=t.split("=")[1]),e},{});return{url:i,queryParameters:r}}(a.mediaSegmentPlaylistUrl),this._currentChunkId=null,this._maxChunksToCache=s.maxChunksToCache||o,this._lowWaterMaxChunks=s.lowWaterMaxChunks||l,t.isNumber(this._maxChunksToCache,"options.maxChunksToCache"),t.isNumber(this._lowWaterMaxChunks,"options.lowWaterMaxChunks"),this._lowWaterMaxChunks>=this._maxChunksToCache)throw new Error('The "maxChunksToCache" cannot be less than or equal to the "lowWaterMaxChunks"');this._initChunk=null,this._dataChunks=[],this._chunkAddedEvent=new i.Event,this._segmentsReadyEvent=new i.Event}var o=20,l=15;return s.prototype=Object.create(r.prototype),s.prototype.constructor=s,s.prototype.toString=function(){return"M3u8PlaylistTrack"},s.prototype.dispose=function(){this._dataChunks=[],this._chunkAddedEvent.dispose()},s.prototype.getMseCodec=function(){return this._mseCodec},s.prototype.getTrackId=function(){return this._trackId},s.prototype.getChunkDuration=function(){return this._chunkDuration},s.prototype.getBandwidth=function(){return this._bandwidth},s.prototype.getHeight=function(){return this._height},s.prototype.getMimeType=function(){return this._mimeType},s.prototype.getTotalNumberOfChunks=function(){return this._totalNumberOfChunks},s.prototype.getPlayableDuration=function(){return this._playableDuration},s.prototype.isComplete=function(){return this._isComplete},s.prototype.hasSegments=function(){return this._mediaSegments.length>0},s.prototype.getSegmentByTimestamp=function(t){return e.find(this._mediaSegments,function(e){return e.timestamp<=t&&t<e.timestamp+e.duration})},s.prototype.getLastSegment=function(){return e.get(this._mediaSegments,[this._mediaSegments.length-1],null)},s.prototype.getMediaSegmentPlaylistUrlInfo=function(){return this._mediaSegmentPlaylistUrlInfo},s.prototype.getClosestSegmentNotGreaterThanTimestamp=function(e){return e>this._playableDuration?this._mediaSegments[this._mediaSegments.length-1]:this.getSegmentByTimestamp(e)},s.prototype.isLastMediaSegment=function(t){var i=this.getSegmentByTimestamp(t),n=!this._isComplete&&e.get(i,["timestamp"],0)+e.get(i,["duration"],0)===this._playableDuration,r=!this._isComplete&&t>this._playableDuration;return this._playableDuration===t||n||r},s.prototype.updateMediaSegments=function(t){var i=new a(this._logger,this._trackId,t),n=this._totalNumberOfChunks||0,r=e.map(this._mediaSegments,function(e){return e.name}),s=this,o=e.get(this._mediaSegments,[this._mediaSegments.length-1]),l=e.get(o,["timestamp"])+e.get(o,["duration"])||void 0;e.forEach(i.mediaSegments,function(t){e.includes(r,t.name)||(t.timestamp=e.isUndefined(l)?0:l,s._mediaSegments.push(t),s._playableDuration+=t.duration,l=t.timestamp+t.duration,t.duration>s._chunkDuration&&(s._chunkDuration=t.duration),s._logger.trace("[%s]:[%s]:[%s] Got new segment from playlist [%s]",(new Date).getHours(),(new Date).getMinutes(),(new Date).getSeconds(),t.name))}),n!==this._mediaSegments.length&&(this._isComplete=i.isComplete,this._totalNumberOfChunks=this._mediaSegments.length,this._segmentsReadyEvent.fireAsync([this._mediaSegments],null,e.noop))},s.prototype.addDataChunk=function(e,i,n){t.isNotUndefined(e,"dataChunk"),n=n||function(){},t.isFunction(n,"eventCallback");var r={data:e,chunkId:i,timestamp:i*this._chunkDuration/1e3};if(this._dataChunks.push(r),this._dataChunks.length>this._maxChunksToCache)for(;this._dataChunks.length>this._lowWaterMaxChunks;)this._dataChunks.shift();this._chunkAddedEvent.fireAsync([r],this,n)},s.prototype.getChunks=function(){return this._dataChunks},s.prototype.addEventListener=function(e,i){switch(t.isString(e,"eventName"),t.isFunction(i,"listener"),e){case"chunkadded":return this._chunkAddedEvent.listen(i);case"segmentsready":return this._segmentsReadyEvent.listen(i);default:throw new Error('Event "'+e+'" is unknown.')}},s}.apply(t,n))&&(e.exports=r)},function(e,t,i){var n,r;n=[i(1),i(0)],void 0!==(r=function(e,t){"use strict";function i(i,r,a){t.isStringNotEmpty(a,"m3u8String"),t.isObject(i,"logger"),this._rawM3U8=a,this._logger=i,this._name=r,this.mediaSegments=[],function(t){var i=t.match(/[^\r\n]+/g),r=this;return e.forEach(i,function(t,a){var s=t.match(/(?!#)EXT.+?(?=[:\n\r])/),o=e.get(s,["0"],null),l=t.trim().substring(o?o.length+2:0,t.length);switch("#EXT-X-ENDLIST"===t&&(o="EXT-X-ENDLIST"),o){case"EXT-X-VERSION":r.version=parseFloat(l);break;case"EXT-X-PROGRAM-DATE-TIME":r.programDateTime=function(e){return e?new Date(e.trim()):null}(l);break;case"EXT-X-TARGETDURATION":r.targetDuration=1e3*parseFloat(l)||0;break;case"EXT-X-MEDIA-SEQUENCE":r.mediaSequence=parseInt(l);break;case"EXTINF":var u=[l,i[a+1]];r.mediaSegments.push(n(u,r.mediaSegments+1));break;case"EXT-X-ENDLIST":r.isComplete=!0;break;case"EXTM3U":case null:break;default:return r._logger.debug("[%s] [Segment] Playlist unsupported key type [%s]",r._name,o)}}),r}.call(this,this._rawM3U8);var s=0;e.forEach(this.mediaSegments,function(e){e.timestamp=s,s+=e.duration}),this.playableDuration=s,this.isComplete=!!this.isComplete}i.prototype.toString=function(){return"vod"};var n=function(t){var i=e.get(t,["0"],"").split(","),n=e.get(i,["0"],0),r=e.get(i,["1"],"").trim(),a=e.get(t,["1"],"").trim();return{duration:parseFloat(n),title:r,name:a}};return i}.apply(t,n))&&(e.exports=r)},function(e,t,i){var n,r;n=[i(0),i(8)],void 0!==(r=function(e,t){"use strict";function i(){}return i.prototype.isCodecSupported=function(i){return e.isStringNotEmpty(i,"codec"),t.global.MediaSource&&"function"==typeof t.global.MediaSource.isTypeSupported&&t.global.MediaSource.isTypeSupported(i)},i.prototype.parseXml=function(i){if(e.isStringNotEmpty(i,"xmlString"),void 0!==t.global.DOMParser)return(new t.global.DOMParser).parseFromString(i,"text/xml");if(void 0!==t.global.ActiveXObject&&new t.global.ActiveXObject("Microsoft.XMLDOM")){var n=new t.global.ActiveXObject("Microsoft.XMLDOM");return n.async="false",n.loadXML(i),n}throw new Error("No XML parser found")},i.prototype.getMSECodec=function(t,i){return e.isStringNotEmpty(t,"mpdMimeType"),e.isStringNotEmpty(i,"mpdCodecs"),t+'; codecs="'+i+'"'},new i}.apply(t,n))&&(e.exports=r)},function(e,t,i){var n,r;n=[i(1),i(0),i(4),i(10)],void 0!==(r=function(e,t,i,n){"use strict";function r(e,n,r){t.isObject(e,"logger"),this._logger=e,this._timeSources=function(e){return e.sort(function(e,t){return o[e.name]-o[t.name]})}(n),this._directSourceOffset=r,this._disposables=new i.DisposableList}function a(e){return(Math.random()-.5)*(e/20)+e}function s(t,i){i=i||0;var r=this,a=e.get(this._timeSources,[i],{});(function(t,i){var r=this;switch(t.name){case"urn:mpeg:dash:utc:http-head:2014":var a=n.getWithRetry(t.value,e.assign({contentType:"text/plain"},l),function(n,a){var s=e.get(a,["headers","date"],""),o=new Date(s).getTime();if(n||isNaN(o))return r._logger.warn("Unable to resolve dash timing via [%s]",t.value,n),i(n||new Error("invalid-server-time"));var l=e.now()-o-a.stats.successResponseTime/2;return r._logger.info("Resolved [%s] local to server timestamp offset [%s]",t.name,l),i(null,l)});return this._disposables.add(a),a;case"urn:mpeg:dash:utc:direct:2014":var s=e.now()-t.value-this._directSourceOffset/2;return r._logger.info("Resolved [%s] local to server timestamp offset [%s]",t.name,s),i(null,s);default:return r._logger.info("Unable to resolve mpd Timing Sources. Defaulting to local time"),i(null,0)}}).call(this,a,function(n,a){if(!e.isNumber(a))return s.call(r,t,i+1);t(n,a)})}var o={"urn:mpeg:dash:utc:http-head:2014":0,"urn:mpeg:dash:utc:direct:2014":1},l={retryOptions:{backoff:2,delay:2e3,maxAttempts:3,additionalRetryErrorCodes:[0]}};return r.prototype.calculateOffset=function(e){s.call(this,e)},r.prototype.setInterval=function(n,r){t.isFunction(n,"callback"),e.isUndefined(r)||t.isNumber(r,"interval");var o=this,l=a(r||3e5),u=setTimeout(function e(){o._logger.debug("Syncing local to server time"),s.call(o,function(t,i){if(t)return n(t);l=a(r||3e5),n(t,i),o._logger.debug("Waiting [%s] ms before next time sync",l),u=setTimeout(e,l)})},l),c=new i.Disposable(function(){clearTimeout(u)});return this._logger.debug("Waiting [%s] ms before next time sync",l),this._disposables.add(c),c},r.prototype.dispose=function(){return this._logger.debug("Disposing of mdp time sync"),this._disposables.dispose()},r.prototype.toString=function(){return"MpdTimeSync [Time Source Number: "+this._timeSources.length+", Direct Source Offset: "+this._directSourceOffset+"]"},r}.apply(t,n))&&(e.exports=r)},function(e,t,i){var n,r;n=[i(1),i(0),i(2),i(3),i(4),i(11),i(8),i(28),i(29),i(5),i(9),i(20),i(15),i(17)],void 0!==(r=function(e,t,i,n,r,a,s,o,l,u,c,d,h,g){"use strict";function f(o,l,u){t.isNotUndefined(l,"videoElement"),t.isNotUndefined(l.videoWidth,"videoElement.videoWidth"),this._logger=o||new i.Logger,this._options=e.assign({targetLatency:m},u),this._videoElement=l,this._disposables=new r.DisposableList,this._browserDetails=new a(s.global.navigator.userAgent).detect(),this._preferNative=this._options.preferNative||!1,this._player=null,this._playbackStarted=!1,this._isWaiting=!1,this._playbackStarted=!1,this._playbackTimeLeftEvent=new n.Event,this._playerStartedEvent=new n.Event,this._playerErrorEvent=new n.Event,this._disposables.add(this._playbackTimeLeftEvent),this._disposables.add(this._playerStartedEvent),this._disposables.add(this._playerErrorEvent)}function p(){var e=this;"Edge"===e._browserDetails.browser||"IE"===e._browserDetails.browser?(e._videoElement.play(),e._playbackStarted=!0,e._playerStartedEvent.fireAsync([],e),e._logger.debug("Playback Started")):e._videoElement.play().then(function(){e._playbackStarted=!0,e._playerStartedEvent.fireAsync([],e),e._logger.debug("Playback Started")}).catch(function(t){e._logger.error("Playback Failed [%s]",t)})}var m=8;return f.prototype.toString=function(){return e.toString(this)},f.prototype.start=function(e){if(t.isStringNotEmpty(e,"uri"),this._player)return this._logger.warn("Already started Phenix Web Player");var i=this;if(l.isSupported){if(this._preferNative||!o.isSupported)return this._logger.info("HLS native player selected"),this._player=new l(this._logger,this._videoElement,this._options),this._player.addEventListener("error",function(e){i._playerErrorEvent.fire([e])}),this._disposables.add(this._player),this._player.start(e,function(){p.call(i)})}else this._preferNative&&this._logger.warn("HLS native player is not supported");this._logger.info("MSE player selected");var n=new u(this._logger,e);i._disposables.add(n),n.fetch(function(e){if(e)return i._playerErrorEvent.fire([e]);var t,r=new c(i._logger,{ewmaPeriods:30});"Dash"===n.getDeliveryType()?t=new h(i._logger,n,r,i._options):"Hls"===n.getDeliveryType()&&(t=new g(i._logger,n,r,i._options));var a=new o(i._logger,n,i._videoElement,t,i._options),s=new d(i._logger,n,i,r);a.start(),p.call(i),i._player=a,i._player.addEventListener("playbacktimeleft",function(e,t){i._playbackTimeLeftEvent.fire([e,t])}),i._player.addEventListener("error",function(e){i._playerErrorEvent.fire([e])}),i._disposables.add(i._player),i._disposables.add(r),i._disposables.add(s)})},f.prototype.play=function(){p.call(this),this._player&&this._player.play()},f.prototype.pause=function(){this._logger.info("Pausing web player"),this._player&&this._player.pause()},f.prototype.getVideoElement=function(){return this._videoElement},f.prototype.dispose=function(){this._disposables.dispose(),this._videoElement&&(this._videoElement.load(),this._videoElement.src="",this._videoElement.mediaKeys&&this._videoElement.setMediaKeys(null)),this._player=null,this._videoElement=null},f.prototype.getBandwidthLimit=function(){this._player.getBandwidthLimit()},f.prototype.getTimeLeft=function(){return this._videoElement?function(t){var i=this._videoElement.currentTime,n=this._videoElement.duration,r=function(e,t){for(var i=0;i<e.buffered.length;i++){var n=e.buffered.start(i),r=e.buffered.end(i);if(n<=t&&t<=r)return i}}(t,i),a=e.isNumber(r)?t.buffered.end(r):0,s=0===a?0:a-i;return{bufferedLength:t.buffered.length,current:i,bufferEnd:a,timeBufferedButNotPlayed:s,duration:n,timestampOffset:t.timestampOffset}}.call(this,this._videoElement).timeBufferedButNotPlayed:0},f.prototype.changeBandwidthLimit=function(e,t){this._player.changeBandwidthLimit(e,t)},f.prototype.addEventListener=function(i,n){switch(t.isString(i,"eventName"),t.isFunction(n,"listener"),i){case"playbacktimeleft":return this._playbackTimeLeftEvent.listen(n);case"started":var r=this._playerStartedEvent.listen(n);return this._playbackStarted&&setTimeout(e.bind(n,this),0),r;case"error":return this._playerErrorEvent.listen(n);default:throw new Error('Event "'+i+'" is unknown.')}},f.prototype.getStats=function(){return this._player?this._player.getStats():{}},f.isSupported=l.isSupported||o.isSupported,f.deviceSupportsHlsPlayback=l.isSupported||o.isSupported,f.deviceSupportsDashPlayback=o.isSupported,f}.apply(t,n))&&(e.exports=r)},function(e,t,i){var n,r;n=[i(1),i(0),i(2),i(3),i(4),i(11),i(8),i(5),i(12),i(18)],void 0!==(r=function(e,t,i,n,r,a,s,o,l,u){"use strict";function c(c,h,g,f,p){t.isInstanceOf(h,o,"playlist"),t.isNotUndefined(g,"videoElement"),t.isNotUndefined(g.videoWidth,"videoElement.videoWidth"),t.isNotUndefined(f,"playlistChunkFeeder"),t.isInstanceOf(f,l,"playlistChunkFeeder"),t.isNumber(p.targetLatency,"options.targetLatency"),e.isUndefined(e.get(p,"bandwidthToStartAt"))||t.isNumber(p.bandwidthToStartAt,"options.bandwidthToStartAt"),e.isUndefined(e.get(p,"trackRestrictions"))||t.isObject(p.trackRestrictions,"options.trackRestrictions"),e.isUndefined(e.get(p,"bufferSizeToPauseFetch"))||t.isNumber(p.bufferSizeToPauseFetch,"options.bufferSizeToPauseFetch"),e.isUndefined(e.get(p,"bufferSizeToResumeFetch"))||t.isNumber(p.bufferSizeToResumeFetch,"options.bufferSizeToResumeFetch"),e.isUndefined(e.get(p,"maximumFrequencyForAlteringPlaybackRate"))||t.isNumber(p.maximumFrequencyForAlteringPlaybackRate,"options.maximumFrequencyForAlteringPlaybackRate"),e.isUndefined(e.get(p,"playbackRateToRecover"))||t.isNumber(p.playbackRateToRecover,"options.playbackRateToRecover");var m=this;this._options=p,this._videoElement=g,this._feeder=f,this._playlist=h,this._disposables=new r.DisposableList,this._logger=c||new i.Logger,this._bandwidthLimit=e.get(p,"bandwidthToStartAt",k),this._trackRestrictions=e.get(p,"trackRestrictions",{}),this._playbackMode=e.get(p,"playbackMode",I.strict.name),this._bufferSizeToPauseFetch=e.get(p,"bufferSizeToPauseFetch",w),this._bufferSizeToResumeFetch=e.get(p,"bufferSizeToResumeFetch",T),this._targetLatencyInMilliseconds=1e3*p.targetLatency,this._playbackStarted=!1,this._isWaiting=!1,this._bufferStats=[],this._browserDetails=new a(s.global.navigator.userAgent).detect();var y=(this._targetLatencyInMilliseconds-(this._playlist.getMaxChunkDuration()||1e3)-500)/this._targetLatencyInMilliseconds;this._playbackRateToDecreaseBuffer=e.get(p,"playbackRateToDecreaseBuffer",S),this._playbackRateToIncreaseBuffer=e.get(p,"playbackRateToIncreaseBuffer",C),this._minimumIntervalBetweenPlaybackRateChange=e.get(p,"minimumIntervalBetweenPlaybackRateChange",D),this._targetBufferSizeToIncreasePlaybackRate=this._targetLatencyInMilliseconds/1e3*y,this._targetBufferSizeToReducePlaybackRate=this._targetLatencyInMilliseconds/1e3/4,this._maxBufferSizeWhilePlaybackRateIsReduced=this._targetLatencyInMilliseconds/1e3/2,this._logger.info("Target latency set to [%s] MS ([%s]/[%s] rates at most every [%s] with target buffers [%s] - [%s] - [%s])",this._targetLatencyInMilliseconds,this._playbackRateToIncreaseBuffer,this._playbackRateToDecreaseBuffer,this._minimumIntervalBetweenPlaybackRateChange,this._targetBufferSizeToReducePlaybackRate,this._maxBufferSizeWhilePlaybackRateIsReduced,this._targetBufferSizeToIncreasePlaybackRate),function(){var t=this,i=e.get(this._playlist,["parsedPlaylist","contentProtectionTags"],[]);if(0===i.length)return this._logger.info("No Content Protection Tags found in the playlist so skipping initialization of EncryptedMediaHandler");if(!u.isSupported())return this._logger.error("DRM not supported by the browser");this._encryptedMediaHandler=new u(this._logger,this._videoElement,i,e.get(this._options,"drm")),this._encryptedMediaHandler.addEventListener("error",function(e){t._playerErrorEvent.fire([e])}),this._encryptedMediaHandler.addEventListener("trackRestrictionsAvailable",function(i){e.keys(i).length>0&&(t._trackRestrictions=i,d.call(t),t._videoElement.play())}),this._disposables.add(this._encryptedMediaHandler)}.call(this),this._playbackStarted=!1,this._mediaSourceBuffers={},this._bufferDetails={},this._playbackTimeLeftEvent=new n.Event,this._playerErrorEvent=new n.Event,this._feeder.addEventListener("error",function(e){m._playerErrorEvent.fire([e])}),this._disposables.add(this._feeder),this._disposables.add(this._playbackTimeLeftEvent),this._disposables.add(this._playerErrorEvent),this._disposables.add(new r.Disposable(function(){null!==m._switchTrackDisposable&&s.global.clearTimeout(m._switchTrackDisposable)}))}function d(){var e=this._playlist.getPlaylistTracksByBandwidthPerMimeType(this._bandwidthLimit,this._trackRestrictions);return this._feeder.setActiveTracks(e),e}function h(e,t,i){this._logger.debug("VIDEO EVENT: [%s]",e,i),t&&t.call(this,i)}function g(t,i){var n=e.bind(h,this,"durationchange",function(){var r=this;if("dynamic"!==r._playlist.getType())return r._videoElement.removeEventListener("durationchange",n,!1),r._readyAt=null;0!==e.get(r._videoElement,["buffered","length"],0)&&function(t,i){var n=this;t=e.isNumber(t)?t:(n._playlist.getPlaybackDurationSinceAvailable()-n._targetLatencyInMilliseconds)/1e3,this._playbackMode===I.strict.name&&(t=(n._playlist.getPlaybackDurationSinceAvailable()-n._targetLatencyInMilliseconds)/1e3),"Firefox"===this._browserDetails.browser&&(t-=1),setTimeout(function(){var r=n._videoElement.buffered.start(n._videoElement.buffered.length-1),a=n._videoElement.buffered.end(n._videoElement.buffered.length-1),s=n._videoElement.currentTime<t||n._videoElement.currentTime>t+1,o=r<=t&&t<=a,l=n._durationChangeCount>=A;if(n._readyAt||!o&&!l&&n._initialized)n._durationChangeCount++;else{if(s&&!n._setTimeoutOnce&&(o||l||!n._initialized)){var u=l?(a-r)/2+r:r;n._initialized||o||(u=r),n._logger.debug("Setting video current time to [%s], attempt [%s]",u,n._durationChangeCount),n._videoElement.currentTime=u,n._setTimeoutOnce=!0,n._initialized||(n._initialized=!0)}r<=n._videoElement.currentTime&&n._videoElement.currentTime<=a&&(o||l)&&(n._readyAt=e.now(),n._setTimeoutOnce=!1,n._logger.debug("Successfully updated video current time [%s] after [%s] attempts",n._videoElement.currentTime,n._durationChangeCount),i())}},10)}.call(r,t,function(){r._videoElement.removeEventListener("durationchange",n,!1),i&&i()})});return this._durationChangeCount=0,n}function f(t){var i=this,n=this._feeder.getActiveTracks(),a=d.call(this);(function(t){if("static"===this._playlist.getType()&&this._mediaSource.duration!==this._playlist.getTotalMediaTimeInMillis()/1e3)this._mediaSource.duration=this._playlist.getTotalMediaTimeInMillis()/1e3;else if("Hls"===this._playlist.getDeliveryType()&&this._mediaSource.duration!==1/0){this._mediaSource.duration=1/0;var i=e.reduce(t,function(t,i){var n=e.get(i.getLastSegment(),["timestamp"],0);return e.isNullOrUndefined(t)?n:n<t?n:t})||0;this._feeder.seekToChunk(i)}}).call(this,a),this._feeder.initializeActiveTracks(function(s){if(s)return i._logger.error("Unable to initialize playlist tracks",s),i._playerErrorEvent.fire([s]),t(s);var o=e.filter(a,function(e){return!i._bufferDetails[b(e)]});if(o.length>0){var l=e.map(o,function(e){return e.getTrackId()});i._logger.info("Initializing source buffers for [%s] tracks [%s]",o.length,l),function(t){this._logger.debug("Creating MSE buffers for all tracks."),e.forEach(t,e.bind(function(t){(function(t){var i=this,n={track:t,chunks:[],chunkAddRequested:!1},a=v(t),s=!e.includes(e.keys(i._mediaSourceBuffers),a),o=s?i._mediaSource.addSourceBuffer(t.getMseCodec()):i._mediaSourceBuffers[a].buffer,l=b(t);i._bufferDetails[l]=n,s&&(o.mode="segments","static"===i._playlist.getType()&&(o.appendWindowEnd=i._playlist.getTotalMediaTimeInMillis()/1e3),i._logger.debug("Creating MSE Buffer for [%s] with mode [%s]",i._playlist.getType(),o.mode),i._mediaSourceBuffers[a]={buffer:o,updateEnd:function(e){o.updating||_.call(this,e,!0)}},i._disposables.add(new r.Disposable(function(){i._logger.debug("Cleaning up sourceBuffer [%s]",a),i._mediaSource.removeSourceBuffer(o)})));var u=t.addEventListener("chunkadded",e.bind(function(t,r){n.addInitChunkFirst&&"Dash"===i._playlist.getDeliveryType()&&(n.addInitChunkFirst=!1,this._logger.debug("Pushing track [%s] chunk [%s] into buffer",t.getTrackId(),"Init"),n.chunks.push(t.getInitChunkData())),this._logger.debug("Pushing track [%s] chunk [%s] into buffer",t.getTrackId(),r.chunkId),n.chunks.push(r.data),n.chunkAddRequested&&(n.chunkAddRequested=!1,o.updating||_.call(this,t,!1));var a=e.now()-this._lastUpdate>=E,s=e.now()-this._lastPlayAttempt>=500;this._isWaiting&&a&&s&&!this._videoElement.paused&&!this._pausedAt&&(this._logger.trace("Starting after wait [%s]",e.now()-this._lastUpdate),this._lastPlayAttempt=e.now(),this._videoElement.play())},i,t));i._disposables.add(u)}).call(this,t)},this))}.call(i,o)}var u=e.filter(a,function(t){return!e.find(n,function(e){return e.getTrackId()===t.getTrackId()})});e.forEach(u,function(t){(function(t){var i=this._mediaSourceBuffers[v(t)],n=e.bind(function(e){this._logger.warn("Buffer Error [%s]",e)},this),r=!!i.track;if(i.track===t)return;var a=this._bufferDetails[b(t)];i.track&&i.track!==t&&r&&(i.buffer.removeEventListener("updateend",i.updateEndListener),i.buffer.removeEventListener("error",n),a&&(a.addInitChunkFirst=!0,a.chunkAddRequested=!0,a.chunks=[]));if(i.track=t,i.updateEndListener=e.bind(i.updateEnd,this,t),i.buffer.addEventListener("updateend",i.updateEndListener),i.buffer.addEventListener("error",n),i.buffer.onerror=n,!r){var s="Dash"===this._playlist.getDeliveryType()?[t.getInitChunkData()]:[];a.chunks=[].concat(s,e.map(t.getChunks(),function(e){return e.data})),"static"===this._playlist.getType()&&"Edge"!==this._browserDetails.browser&&"IE"!==this._browserDetails.browser&&this._mediaSource.setLiveSeekableRange(0,this._playlist.getTotalMediaTimeInMillis()/1e3),_.call(this,t,!1)}}).call(i,t),i._logger.info("Switched [%s] to track [%s] with [%s] bandwidth limit",v(t),t.getTrackId(),i._bandwidthLimit)}),t()})}function p(t){var i=this._videoElement.currentTime,n=this._videoElement.duration,r=m(t,i),a=e.isNumber(r)?t.buffered.end(r):0,s=0===a?0:a-i;return{bufferedLength:t.buffered.length,current:i,bufferEnd:a,timeBufferedButNotPlayed:s,duration:n,timestampOffset:t.timestampOffset}}function m(e,t){for(var i=0;i<e.buffered.length;i++){var n=e.buffered.start(i),r=e.buffered.end(i);if(n<=t&&t<=r)return i}}function y(){var t=!0,i=!1;e.forOwn(this._mediaSourceBuffers,e.bind(function(e){var n=p.call(this,e.buffer),r=parseFloat(n.timeBufferedButNotPlayed);r<this._bufferSizeToPauseFetch&&(t=!1),r<this._bufferSizeToResumeFetch&&(i=!0)},this)),t&&this._feeder.isFetchingData()&&(this._logger.debug("Pausing feeder due to excess buffer"),L.call(this)),!i||this._feeder.isFetchingData()||this._pausedAt||(this._logger.debug("Starting feeder due to limited buffer"),x.call(this))}function _(t,i){var n=this._mediaSourceBuffers[v(t)],r=this._bufferDetails[b(t)];if(!r)return this._logger.warn("Unable to add chunk for non existent buffer");if("dynamic"===this._playlist.getType()&&this._pausedAt&&!this._reset&&n.buffer.buffered.length>0)n.buffer.remove(0,n.buffer.buffered.end(n.buffer.buffered.length-1)),n.cleared=!0,e.reduce(this._mediaSourceBuffers,function(e,t){return e?t.cleared:e},!0)&&(this._initialized=!1,this._readyAt=null,this._setTimeoutOnce=!1,this._reset=!0);else if(r.chunks.length>0){if(this._videoElement.error)return this._logger.error("Unable to continue appending to buffer. Video element error code [%s] and message [%s]",this._videoElement.error.code,this._videoElement.error.message),L.call(this),this._playerErrorEvent.fire([this._videoElement.error]);var a=r.chunks.shift();n.cleared=!1,this._logger.debug("Appending chunk to buffer for track [%s]",t.getTrackId()),n.buffer.appendBuffer(new Uint8Array(a))}else i&&(this._lastPlayAttempt&&y.call(this),r.chunkAddRequested=!0)}function v(e){return e.getMseCodec().indexOf("video")>=0?"video":e.getMseCodec().indexOf("audio")>=0?"audio":"other"}function b(e){return e.getTrackId()+"_"+e.getMseCodec()}var k=2e6,w=60,T=30,E=1e3,S=1.03,C=.97,D=300,M=4e3,P=3e5,A=2,R=500,I={loose:{id:0,name:"loose"},strict:{id:1,name:"strict"}};c.prototype.toString=function(){return e.toString(this)},c.prototype.play=function(){if("dynamic"===this._playlist.getType()){var e=this._feeder.seekToCurrent();x.call(this);var t=this,i=g.call(this,e,function(){t._pausedAt=0,t._videoElement&&t._videoElement.play()});return setTimeout(function(){t._videoElement.addEventListener("durationchange",i,!1)},300),this._disposables.add(new r.Disposable(function(){t._videoElement.removeEventListener("durationchange",i,!1)}))}x.call(this),this._videoElement&&this._videoElement.play()},c.prototype.pause=function(){this._logger.info("Pausing web player"),L.call(this);var t=this;this._videoElement&&(this._videoElement.pause(),this._pausedAt=e.now(),this._reset=!1,e.forOwn(this._feeder.getActiveTracks(),function(e){t._mediaSourceBuffers[v(e)].buffer.updating||_.call(t,e,!1)}))},c.prototype.dispose=function(){this._disposables.dispose(),this._playbackStarted=!1,this._mediaSourceBuffers={},this._bufferDetails={},this._bufferStats=[],this._mediaSource=null,this._playlist=null,this._videoElement=null},c.prototype.start=function(t){(function(t){var i=this;i._mediaSource=new MediaSource;var n=function(){(function(t){var i=this;f.call(i,function n(a){if(a)return t(a);var s=i._feeder.getActiveTracks(),o=e.map(s,function(e){return e.getTrackId()});i._logger.debug("Initializing tracks [%s]",o);var l=setTimeout(function(){return i._feeder.stopRequestingAllData(),i._bandwidthLimit=i._bandwidthLimit/2,f.call(i,n)},i._playlist.getMaxChunkDuration());i._feeder.fetchNChunks(1,function(n){if("timeout"!==e.get(n,["message"])){if(clearTimeout(l),n)return t(n);"Hls"===i._playlist.getDeliveryType()&&e.forEach(i._feeder.getActiveTracks(),function(e){i._bufferDetails[b(e)].chunkAddRequested=!0}),i._logger.info("Initializing feeder with [%s] [%s] playlist of duration [%s]",i._playlist.getType(),i._playlist.getDeliveryType(),i._playlist.getTotalMediaTimeInMillis()/1e3),function(t){var i=this,n=e.bind(function(){this._isWaiting=!1,this._lastUpdate=e.now();var t,i=e.now()-this._startTime>M;e.forOwn(this._mediaSourceBuffers,e.bind(function(e){var i=p.call(this,e.buffer);(!t||t>i.timeBufferedButNotPlayed)&&(t=i.timeBufferedButNotPlayed),this._playbackTimeLeftEvent.fire([i.timeBufferedButNotPlayed,e.track],this)},this)),y.call(this),i&&(function(t){this._bufferStats.push({size:t,timestamp:e.now()});for(var i=e.get(this._bufferStats,[0,"timestamp"],e.now());e.now()-i>P;)this._bufferStats.shift(),i=e.get(this._bufferStats,[0,"timestamp"],e.now());this._bufferStatsMin=Math.min.apply(null,e.map(this._bufferStats,function(e){return e.size}))}.call(this,t),function(t){if("Dash"===this._playlist.getDeliveryType()||"dynamic"===this._playlist.getType()){var i=this._targetBufferSizeToIncreasePlaybackRate,n=this._lastPlaybackRateChange,r=e.now()-this._startTime>M,a=!n||e.now()-n>1e3*this._minimumIntervalBetweenPlaybackRateChange,s=this._targetLatencyInMilliseconds/1e3,o=this._bufferStatsMin>this._targetBufferSizeToReducePlaybackRate,l=this._bufferStatsMin<=s+.1&&this._bufferStatsMin>=s-.1,u=t>=this._maxBufferSizeWhilePlaybackRateIsReduced&&this._videoElement.playbackRate===this._playbackRateToIncreaseBuffer;t>=i&&o&&this._videoElement.playbackRate<=1&&r&&a?(this._logger.info("Adjusting playback rate to [%s] to reduce buffer size from [%s] with minimum buffer size of [%s]",this._playbackRateToDecreaseBuffer,t,this._bufferStatsMin),this._videoElement.playbackRate=this._playbackRateToDecreaseBuffer):!o&&!l&&this._videoElement.playbackRate>=1&&a?(this._logger.info("Adjusting playback rate to [%s] to increase buffer size from [%s] with minimum buffer size of [%s]",this._playbackRateToIncreaseBuffer,t,this._bufferStatsMin),this._videoElement.playbackRate=this._playbackRateToIncreaseBuffer):(u||l)&&1!==this._videoElement.playbackRate&&(this._logger.info("Resuming normal playback rate with buffer size of [%s] and minimum buffer size of [%s]",t,this._bufferStatsMin),this._videoElement.playbackRate=1,this._lastPlaybackRateChange=e.now())}}.call(this,t||0))},i),a=e.bind(h,i,"stalled",null),s=e.bind(h,i,"suspend",null),o=e.bind(h,i,"ended",null),l=e.bind(h,i,"error",null),u=e.bind(h,i,"pause",null),c=e.bind(h,i,"play",function(){this._pausedAt&&this._videoElement.pause()}),d=e.bind(h,i,"waiting",function(){this._playbackStarted&&(this._logger.debug("Waiting for new chunk or end of track"),this._isWaiting=!0)}),f=e.bind(h,i,"seeking",function(t){var i=e.keys(this._mediaSourceBuffers),n=e.get(i,"0",null),r=this._mediaSourceBuffers[n],a=e.now()-this._readyAt,s=this;if(!(r&&a>R&&"Hls"!==this._playlist.getDeliveryType()))return this._logger.debug("Ignoring video seek event during initialization");var o=m(r.buffer,t.timeStamp/1e3),l=m(r.buffer,this._videoElement.currentTime),u=e.reduce(this._mediaSourceBuffers,function(t,i){var n=m(i.buffer,s._videoElement.currentTime),r=e.isNumber(n)?i.buffer.buffered.end(n):0;return t?r<t?r:t:r})||this._videoElement.currentTime;if(this._feeder.stopRequestingAllData(),this._logger.debug("Pausing of feeder completed."),this._feeder.seekToChunk("dynamic"===this._playlist.getType()?this._videoElement.currentTime:u),o!==l||e.isNullOrUndefined(l)){if(this._feeder.isFetchingData())return;this._feeder.startRequestingDataForActiveTracks(this._bandwidthLimit)}}),_=g.call(i);i._videoElement.addEventListener("timeupdate",n,!1),i._videoElement.addEventListener("ended",o,!1),i._videoElement.addEventListener("error",l,!1),i._videoElement.addEventListener("pause",u,!1),i._videoElement.addEventListener("stalled",a,!1),i._videoElement.addEventListener("suspend",s,!1),i._videoElement.addEventListener("play",c,!1),i._videoElement.addEventListener("waiting",d,!1),i._videoElement.addEventListener("seeking",f,!1),i._videoElement.addEventListener("durationchange",_,!1),i._disposables.add(new r.Disposable(function(){i._logger.debug("Cleaning up videoElement listeners"),i._videoElement.removeEventListener("timeupdate",n,!1),i._videoElement.removeEventListener("ended",o,!1),i._videoElement.removeEventListener("error",l,!1),i._videoElement.removeEventListener("pause",u,!1),i._videoElement.removeEventListener("stalled",a,!1),i._videoElement.removeEventListener("suspend",s,!1),i._videoElement.removeEventListener("play",c,!1),i._videoElement.removeEventListener("waiting",d,!1),i._videoElement.removeEventListener("seeking",f,!1),i._videoElement.removeEventListener("durationchange",_,!1)})),x.call(i),i._lastPlayAttempt=e.now(),e.isFunction(t)&&t()}.call(i,t)}})})}).call(i,t)};i._mediaSource.addEventListener("sourceopen",n),i._disposables.add(new r.Disposable(function(){i._logger.debug("Cleaning up sourceopen listener"),i._mediaSource.removeEventListener("sourceopen",n)})),i._videoElement.src=s.global.URL.createObjectURL(i._mediaSource)}).call(this,t),this._startTime=e.now()},c.prototype.getBandwidthLimit=function(){return this._bandwidthLimit},c.prototype.changeBandwidthLimit=function(t,i){this._logger.debug("Changing playback bandwidth limit: [%s], current limit: [%s]",t,this._bandwidthLimit),this._bandwidthLimit=t,this._switchTrackDisposable=setTimeout(e.bind(function(t){var i=this;f.call(this,function(n){if(n)return t(n);var r=i._feeder.getActiveTracks(),a=e.reduce(r,function(t,n){var r=i._mediaSourceBuffers[v(n)],a=m(r.buffer,i._videoElement.currentTime),s=n.getChunkDuration()/1e3;if(!e.isNumber(a))return!e.isNumber(t)||t>i._videoElement.currentTime?i._videoElement.currentTime:t;var o=Math.round(r.buffer.buffered.end(a)/s)*s;return!e.isNumber(t)||t>o?o:t});return e.isNumber(a)||(a=i._videoElement.currentTime),i._feeder.stopRequestingAllData(),i._feeder.seekToChunk(a),i._logger.debug("Pausing of feeder completed."),i._feeder.isFetchingData()?t():(i._feeder.startRequestingDataForActiveTracks(i._bandwidthLimit),t())})},this,i||e.noop),250)},c.prototype.addEventListener=function(e,i){switch(t.isString(e,"eventName"),t.isFunction(i,"listener"),e){case"playbacktimeleft":return this._playbackTimeLeftEvent.listen(i);case"error":return this._playerErrorEvent.listen(i);default:throw new Error('Event "'+e+'" is unknown.')}},c.prototype.getStats=function(){return{currentTime:e.get(this._element,["currentTime"],0),width:e.get(this._element,["videoWidth"],0)||e.get(this._element,["width"],0),height:e.get(this._element,["videoHeight"],0)||e.get(this._element,["height"],0),lag:0,deliveryType:this._playlist.getDeliveryType(),isNative:!1}},c.isSupported=!!s.global.MediaSource;var L=function(){this._feeder.stopRequestingAllData(),this._logger.debug("Pausing of feeder completed.")},x=function(){if(this._feeder.isFetchingData())return this._logger.debug("Unable to start requesting data. Feeder is already fetching data.");this._feeder.startRequestingDataForActiveTracks()};return c}.apply(t,n))&&(e.exports=r)},function(e,t,i){var n,r;n=[i(1),i(0),i(2),i(3),i(4),i(11),i(19),i(8),i(5),i(18),i(6)],void 0!==(r=function(e,t,i,n,r,a,s,o,l,u,c){"use strict";function d(s,d,m){t.isNotUndefined(d,"videoElement"),t.isNotUndefined(d.videoWidth,"videoElement.videoWidth"),this._options=m,this._videoElement=d,this._disposables=new r.DisposableList,this._logger=s||new i.Logger,this._browserDetails=new a(o.global.navigator.userAgent).detect(),this._playerErrorEvent=new n.Event,this._disposables.add(this._playerErrorEvent),this._onStalled=e.bind(function(){var e=this,t=this._element.currentTime,i=function(){return 1.5*this._lastProgress.averageLength<4e3?4e3:1.5*this._lastProgress.averageLength}.call(e);if(e._element.paused)return;setTimeout(function(){if(0===e._lastProgress.count&&!e._element.paused&&e._element.currentTime===t){var n="Stream has not started within ["+i/1e3+"] seconds";e._logger.warn(n),f.call(e,c.name.progressTimeOut.name,n)}},i),setTimeout(function(){if(e._element&&e._element.currentTime===t&&!e._element.paused&&h.call(e)){var i="Stream has been stalled for ["+_/1e3+"] seconds";e._logger.warn(i),g.call(e,c.name.progressTimeOut.name,i)}},_)},this),this._onProgress=e.bind(function(){if(this._lastProgress.time=e.now(),0===this._element.buffered.length)return this._logger.debug("[%s] Hls stream progress event fired without any buffered content",this._uri);var t=this._element.buffered.end(this._element.buffered.length-1);if(this._lastProgress.buffered===t)return;if(null!==this._lastProgress.buffered){var i=this._lastProgress.averageLength*this._lastProgress.count+(t-this._lastProgress.buffered);if(this._lastProgress.count+=1,this._lastProgress.averageLength=i/this._lastProgress.count,this._lastProgress.lastCurrentTime!==this._element.currentTime&&(this._lastProgress.lastCurrentTimeOccurrenceTimestamp=e.now()),this._lastProgress.lastCurrentTimeOccurrenceTimestamp&&e.now()-this._lastProgress.lastCurrentTimeOccurrenceTimestamp>_&&this._element&&!this._element.paused&&h.call(this)){var n="Reloading stream after current time has not changed for ["+_/1e3+"] seconds due to unregistered stall.";this._logger.warn(n),g.call(this,c.name.progressTimeOut.name,n)}}this._lastProgress.buffered=t,this._lastProgress.lastCurrentTime=this._element.currentTime},this),this._onEnded=e.bind(function(){this._logger.info("[%s] Hls stream ended",this._streamId),this.stop("ended")},this),this._onError=e.bind(function(t){var i=this,n=0===i._lastProgress.count;4===e.get(this._element,["error","code"])&&n&&f.call(i,c.name.hlsNativeError.name,t);p.call(this,c.name.hlsNativeError.name,t)},this),this._lastProgress={time:0,buffered:null,averageLength:0,count:0,lastCurrentTime:0,lastCurrentTimeOccurrenceTimestamp:0},this._bufferSizeHistory=[],function(){var t=this,i=e.get(this._options,["drm","com.apple.fps.1_0"],{});if(0===e.keys(i).length)return this._logger.info("DRM config is empty so skipping initialization of EncryptedMediaHandler");if(!u.isSupported())return this._logger.error("DRM not supported by the browser");this._encryptedMediaHandler=new u(this._logger,this._videoElement,[],e.get(this._options,"drm")),this._encryptedMediaHandler.addEventListener("error",function(e){t._playerErrorEvent.fire([e])}),this._encryptedMediaHandler.addEventListener("trackRestrictionsAvailable",function(i){e.keys(i).length>0&&(t._trackRestrictions=i)}),this._disposables.add(this._encryptedMediaHandler)}.call(this),setTimeout(e.bind(function(){this._playlist=new l(this._logger,this._uri),this._disposables.add(this._playlist),this._playlist.fetch(e.noop)},this),b)}function h(){return this._element&&0!==this._element.buffered.length}function g(e,t){if(!h.call(this))return p.call(this,e,t);f.call(this,e,t)}function f(e,t){this._playerErrorEvent.fire([y(e,c.severity.RECOVERABLE,t)])}function p(e,t){this._playerErrorEvent.fire([y(e,c.severity.CRITICAL,t)])}function m(t){if(t){if(clearTimeout(this._backgroundTimeout),this._backgroundTimeout=null,!this._backgroundThrottled)return;return this._backgroundThrottled=!1,void this.start(this._element)}var i=this;this._backgroundTimeout=setTimeout(function(){s.isForeground()||function(t){if(t.muted)return!1;return e.get(t,["webkitAudioDecodedByteCount"],0)>0||e.get(t,["audioTracks","length"],0)>0||t.webkitHasAudio}(i._element)||(i._logger.info("Detecting application [background] with muted video. Pausing playback until application focused again."),i._element.pause(),i._backgroundThrottled=!0)},v)}function y(e,t,i){return{category:c.category.STREAMING,name:e,severity:t,error:"Error"===i.constructor.name?i:new Error(i)}}var _=6e3,v=3e3,b=2e3;return d.prototype.toString=function(){return e.toString(this)},d.prototype.play=function(){this._videoElement.play()},d.prototype.pause=function(){this._videoElement.pause()},d.prototype.dispose=function(){this._disposables.dispose()},d.prototype.start=function(t){if(this._uri)return this._logger.warn("Already started player");this._uri=t,this._disposables.add(s.onBackground(e.bind(m,this,!1))),this._disposables.add(s.onForeground(e.bind(m,this,!0))),function(t){o.attachUriStream(t,this._uri),!1===this._options.receiveAudio&&(t.muted=!0),e.addEventListener(t,"error",this._onError,!0),e.addEventListener(t,"stalled",this._onStalled,!1),e.addEventListener(t,"pause",this._onStalled,!1),e.addEventListener(t,"suspend",this._onStalled,!1),e.addEventListener(t,"progress",this._onProgress,!1),e.addEventListener(t,"ended",this._onEnded,!1),this._element=t}.call(this,this._videoElement)},d.prototype.getBandwidthLimit=function(){return this._logger.warn("getBandwidthLimit not supported for HLS Native")},d.prototype.changeBandwidthLimit=function(){return this._logger.warn("changeBandwidthLimit not supported for HLS Native")},d.prototype.addEventListener=function(e,i){switch(t.isString(e,"eventName"),t.isFunction(i,"listener"),e){case"error":return this._playerErrorEvent.listen(i);default:throw new Error('Event "'+e+'" is unknown.')}},d.prototype.getStats=function(){if(!this._videoElement)return{width:0,height:0,currentTime:0,lag:0,deliveryType:"Hls",isNative:!0};var t=e.get(this._element,["currentTime"],0),i=this._element&&this._element.buffered&&this._element.buffered.length>0?this._element.buffered.end(this._element.buffered.length-1):0,n=Math.max(0,i-t);this._bufferSizeHistory.push(n),this._bufferSizeHistory.length>15&&this._bufferSizeHistory.shift();for(var r=0,a=0,s=this._bufferSizeHistory.length;a<s;a++)r=Math.max(r,this._bufferSizeHistory[a]);var o=2;this._playlist&&this._playlist.getAllPlaylistTracks().length>0&&(o=this._playlist.getAllPlaylistTracks()[0].getChunkDuration());var l=2*o+r;return{width:this._element.videoWidth||this._element.width,height:this._element.videoHeight||this._element.height,currentTime:t,lag:l,deliveryType:"Hls",isNative:!0}},d.isSupported="object"==typeof document&&"maybe"===document.createElement("video").canPlayType("application/vnd.apple.mpegURL"),d}.apply(t,n))&&(e.exports=r)}])});
...
], __WEBPACK_AMD_DEFINE_RESULT__ = (function(_, assert, observable, disposable, AdminAPI, PCastExpress, RoomService, MemberSelector, Stream, roomEnums, memberEnums, memberStreamEnums, trackEnums, FeatureDetector) {
    'use strict';
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
    ...
    var sdkVersion = '2018-07-30T19:12:02Z';
